Return-Path: <linux-cifs+bounces-8440-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 86B00CDB2EA
	for <lists+linux-cifs@lfdr.de>; Wed, 24 Dec 2025 03:33:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 634FE300C167
	for <lists+linux-cifs@lfdr.de>; Wed, 24 Dec 2025 02:33:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE6A423EAB9;
	Wed, 24 Dec 2025 02:33:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="HNIn/Enh"
X-Original-To: linux-cifs@vger.kernel.org
Received: from out-171.mta1.migadu.com (out-171.mta1.migadu.com [95.215.58.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C0F62797AC
	for <linux-cifs@vger.kernel.org>; Wed, 24 Dec 2025 02:33:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1766543586; cv=none; b=EjKNox44aVySnf9CQAawhuMTtScw2SI4Vtc4IgDDLS506N6eapbLf52afCevSklircN8K87YPW1Rq2EQVtQcUV7egTjNtZHsinScqDhJZKPx4O/ptWSoKmsbXMfw9qjLYPzrUpQm8L0sfVIs9NSjnCWZSZKSGcAIp820WqWMMPE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1766543586; c=relaxed/simple;
	bh=y4PeXsAY6MWnyO44ZICmU1YzO741XDWqODRVkwnFw7A=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=nRioxfKKxcB/JvzPnRJGZEvT2OqN68vH0dUWCSK3cyB3Lq/Lbna1GN2JahKRzO3OM36EdTCln82HdcGCMW0b1BPWdDDOCwyBioPkFsEif+AvHW+0BF1yOYQv6hf6Vfoma9mlfeMEhUOI8Kd6oppD5CLPCOMg+IwxB9rjeOxoJpc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=HNIn/Enh; arc=none smtp.client-ip=95.215.58.171
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
	...
	bh=8RGuxTF5YhePM2Hvh1M66ItJpV1UMgeIjk9lOXK5gnU=;
	b=HNIn/EnhB0B6bEeYo2D4uUw75YWY6MdtcucPdzs7X3rFpl6z1+jg3BrxpM1u9eZhZyCzBz
	1l6DX0u6OJINu+/09rnjPCmpOpeBib/ShbY9EQRrM3rE1TVgIdvmVQy6kVbqxMElWao+gN
	/op88b9Dm2M0w4EyE01Kb8dRha/nSoM=
...
Subject: [PATCH v5 2/5] cifs: Autogenerate SMB2 error mapping table
Date: Wed, 24 Dec 2025 10:31:41 +0800
Message-ID: <20251224023145.608165-3-chenxiaosong.chenxiaosong@linux.dev>
...
---
 ...
 fs/smb/client/smb2maperror.c   | 2397 +-------------------------------
 3 files changed, 101 insertions(+), 2395 deletions(-)
...
index 000000000000..98f32ec75316
--- /dev/null
...
+        $pad = "\t" x ((($n-1) / 8) + 1);
+    }
+    print(OUT_FILE "{ /*$code*/ $status, $error, \"$full_status\" },\n");
+
+    $full_status = "";
+}
+close OUT_FILE || die;
diff --git a/fs/smb/client/smb2maperror.c b/fs/smb/client/smb2maperror.c
index 4e1db02d22cb..573d74cd510d 100644
--- a/fs/smb/client/smb2maperror.c
+++ b/fs/smb/client/smb2maperror.c
@@ -23,2401 +23,8 @@ struct status_to_posix_error {
 };
