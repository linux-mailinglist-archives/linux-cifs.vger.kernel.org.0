Return-Path: <linux-cifs+bounces-9637-lists+linux-cifs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-cifs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CPa0FQp9oGlhkQQAu9opvQ
	(envelope-from <linux-cifs+bounces-9637-lists+linux-cifs=lfdr.de@vger.kernel.org>)
	for <lists+linux-cifs@lfdr.de>; Thu, 26 Feb 2026 18:04:10 +0100
X-Original-To: lists+linux-cifs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B6A11ABA48
	for <lists+linux-cifs@lfdr.de>; Thu, 26 Feb 2026 18:04:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 8C53133E4681
	for <lists+linux-cifs@lfdr.de>; Thu, 26 Feb 2026 16:53:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1D378478E52;
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-9637-lists,linux-cifs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	RSPAMD_URIBL_FAIL(0.00)[oracle.com:query timed out,oracle.onmicrosoft.com:query timed out];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[dave.kleikamp.oracle.com:query timed out];
	TO_DN_SOME(0.00)[];
	PRECEDENCE_BULK(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[dave.kleikamp@oracle.com,linux-cifs@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
