Return-Path: <linux-cifs+bounces-2002-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B9EB18B7924
	for <lists+linux-cifs@lfdr.de>; Tue, 30 Apr 2024 16:24:20 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6EF86281644
	for <lists+linux-cifs@lfdr.de>; Tue, 30 Apr 2024 14:24:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 874D83DAC1A;
	Tue, 30 Apr 2024 14:10:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="W8PrJ+PP"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8408C1A38DE
	for <linux-cifs@vger.kernel.org>; Tue, 30 Apr 2024 14:10:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714486224; cv=none; b=QLw+Xf3nmrWXa3KH19534Wp86EQ2qPqQRsZKlB2QJSZumI1CylNNYpOls8MHtDco63YvySWtXLAfeffurWcjCNaVlVvEWUSfgopFC60uErnPoy2O26htcEM5dxg7B7AMoVCynsoR/fLQzTKEamK6UQFRJ+jYexcYujl1pcylqwQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714486224; c=relaxed/simple;
	bh=spsLoazxtUwtEgTQjk8bqaZqzn75ksFQOI9Kub8JGts=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=UGwcDeftv5PRwIkH35y5L/67IRqLbq2J5yHvDvCeoJPdZcp+IxNhbJhiUcngIYH6flGD75h82knmM09VTVuJlwqrFy2sZyUVVSB3kJhRBEE2sFSkAB04KW8BfjPb7+Odnk0LA3YV19vOjRvyLobqb5WmNlOv+IybSn93WI/VGwI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=W8PrJ+PP; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1714486220;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=yKaNR9AKTWcUwD2w+7NjU9T3p15M55NlqaAMNfxW4+0=;
	b=W8PrJ+PPwlQvMUZUanySvxHPzfqcsiZKQvrGUppmOKMj581B00GID5MJfA/WGFwEXsZDTQ
	MsCRpkFogj80Y3T+h9F8MPQHaZMn1Kk2XgtYpnayYf0b4oNXEWLZRwbwJh/XAoUdyu7yvK
	Vu18ydEKWBHIGTXYPkcZMLMtBP+eys8=
Received: from mimecast-mx02.redhat.com (mx-ext.redhat.com [66.187.233.73])
 by relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-349-hcfV79lONc22040fc10prw-1; Tue,
 30 Apr 2024 10:10:15 -0400
X-MC-Unique: hcfV79lONc22040fc10prw-1
Received: from smtp.corp.redhat.com (int-mx10.intmail.prod.int.rdu2.redhat.com [10.11.54.10])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 5892029AA391;
	Tue, 30 Apr 2024 14:10:14 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.22])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 0BA0F477F80;
	Tue, 30 Apr 2024 14:10:11 +0000 (UTC)
...
Subject: [PATCH v7 15/16] cifs: Remove some code that's no longer used, part 3
Date: Tue, 30 Apr 2024 15:09:27 +0100
Message-ID: <20240430140930.262762-16-dhowells@redhat.com>
...
index f504cda886f0..4c981ce89f8a 100644
--- a/fs/smb/client/file.c
+++ b/fs/smb/client/file.c
@@ -2743,471 +2743,6 @@ int cifs_flush(struct file *file, fl_owner_t id)
 	return rc;
 }
...
-
 ...
 {
@@ -3296,450 +2831,6 @@ cifs_strict_writev(struct kiocb *iocb, struct iov_iter *from)
 	return written;
 }
...
-
 ...
 {
 	ssize_t rc;
@@ -3838,101 +2929,6 @@ cifs_strict_readv(struct kiocb *iocb, struct iov_iter *to)
 	return rc;
 }
