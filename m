...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 10640E5FAE
	for <lists+linux-cifs@lfdr.de>; Sat, 26 Oct 2019 23:04:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726392AbfJZVEg (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Sat, 26 Oct 2019 17:04:36 -0400
Received: from us-smtp-1.mimecast.com ([207.211.31.81]:32789 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726386AbfJZVEg (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>);
        Sat, 26 Oct 2019 17:04:36 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1572123874;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=I7sCCPVx6ARUzD7NKPApj2YipgDUIKbnuBu2pIdKss4=;
        b=Kkw9DcQEq+TNy1xyUOto5TYIQvI9Z5huXwba0HrR1zEIYdw4ztwnrWvoU+gh8o+FEI7Cca
        nVstTEgGNR5zEH0he5obqVwzW6Stg+WN/ZR5dPSp47JntsFvAiJJIEqCz31cyuWFyMdXjc
        f/co9yj0jKx6v0c97v6JVPNlTmH5JUc=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-87-yChKBcp7M82uScjk5L21HQ-1; Sat, 26 Oct 2019 17:04:33 -0400
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 56BFD107AD25
        for <linux-cifs@vger.kernel.org>; Sat, 26 Oct 2019 21:04:32 +0000 (UTC)
Received: from test1135.test.redhat.com (vpn2-54-48.bne.redhat.com [10.64.54.48])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 7D5A960C4B;
        Sat, 26 Oct 2019 21:04:29 +0000 (UTC)
From:   Ronnie Sahlberg <lsahlber@redhat.com>
To:     linux-cifs <linux-cifs@vger.kernel.org>
Cc:     Ronnie Sahlberg <lsahlber@redhat.com>
Subject: [PATCH] cifs: move cifsFileInfo_put logic into a work-queue
Date:   Sun, 27 Oct 2019 07:04:19 +1000
Message-Id: <20191026210419.7575-2-lsahlber@redhat.com>
In-Reply-To: <20191026210419.7575-1-lsahlber@redhat.com>
References: <20191026210419.7575-1-lsahlber@redhat.com>
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.12
X-MC-Unique: yChKBcp7M82uScjk5L21HQ-1
...
@@ -1902,6 +1902,7 @@ void cifs_queue_oplock_break(struct cifsFileInfo *cfi=
le);
...
ndler)
+static void
+_cifsFileInfo_put_work(struct cifsFileInfo *cifs_file, bool wait_oplock_ha=
ndler)
 {
...
+=09struct work_struct put;
+=09struct cifsFileInfo *cifs_file;
+=09bool wait_oplock_handler;
+};
+
+static void cifsFileInfo_put_work(struct work_struct *work)
+{
+=09struct cifsFileInfo_w *cfiw =3D container_of(work,
+=09=09=09=09=09=09   struct cifsFileInfo_w, put);
+=09_cifsFileInfo_put_work(cfiw->cifs_file, cfiw->wait_oplock_handler);
+=09kfree(cfiw);
+}
+
+/**
...
ndler)
+{
+=09struct cifsFileInfo_w *work;
+
+=09work =3D kmalloc(sizeof(struct cifsFileInfo_w), GFP_KERNEL);
+=09if (work =3D=3D NULL) {
+=09=09_cifsFileInfo_put_work(cifs_file, wait_oplock_handler);
+=09=09return;
+=09}
+
+=09INIT_WORK(&work->put, cifsFileInfo_put_work);
+=09work->cifs_file =3D cifs_file;
+=09work->wait_oplock_handler =3D wait_oplock_handler;
+=09queue_work(fileinfo_put_wq, &work->put);
+}
+
