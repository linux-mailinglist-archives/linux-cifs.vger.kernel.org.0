Return-Path: <linux-cifs+bounces-9123-lists+linux-cifs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-cifs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SFoqCxmAd2m9hgEAu9opvQ
	(envelope-from <linux-cifs+bounces-9123-lists+linux-cifs=lfdr.de@vger.kernel.org>)
	for <lists+linux-cifs@lfdr.de>; Mon, 26 Jan 2026 15:54:17 +0100
X-Original-To: lists+linux-cifs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 9820889C42
	for <lists+linux-cifs@lfdr.de>; Mon, 26 Jan 2026 15:54:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id C61383034CAA
	for <lists+linux-cifs@lfdr.de>; Mon, 26 Jan 2026 14:53:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9B3F1330B36;
	Mon, 26 Jan 2026 14:53:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="hR8XFn20"
X-Original-To: linux-cifs@vger.kernel.org
Received: from mail-qk1-f170.google.com (mail-qk1-f170.google.com [209.85.222.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E2F77337BB0
	for <linux-cifs@vger.kernel.org>; Mon, 26 Jan 2026 14:53:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1769439193; cv=none; b=BiMcvJjakZFX2918vI2Cp+ZYsVXMz6YG5YqBE2yQiVqotttHo5AogDSF7rh+ncyBHcfHEMtMhMd8HKKCaeclWKWu2+sxxb7Zno4uw3NnBmg01XMmr/w++oPobINfxWDTkXDb/TrkXu07fYx4Hq/w02kcHdlhF5LBTH/PTvE+O1s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1769439193; c=relaxed/simple;
	bh=zK+VowBTzhGSoFw5QNszzZ2jLiRcqoAjYwKUDjA0/Io=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=laBZKUgjSHlxYMn9ejOHhWgzQLegW4sN+X4VCMzonS5VsNyyG7QCu9jVPHka2jDVU8xAXzu2Df8ti1U7RBj49u6cwbdAOwcJiZZIeVj93Ks/q0vVvzQqFD8zihDINRw/QEqxusPGRlYRsQNzTIvjtLUlbqpW/S2jRoPSWdm6j5k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=hR8XFn20; arc=none smtp.client-ip=209.85.222.170
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-qk1-f170.google.com with SMTP id af79cd13be357-8c52f15c5b3so471367685a.3
        for <linux-cifs@vger.kernel.org>; Mon, 26 Jan 2026 06:53:10 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1769439190; x=1770043990; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=vqtWTeMYfTgXU9PtJgEtafBxIuNX0sI2V7I6uzIL7HQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1769439190; x=1770043990;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
         :to:cc:subject:date:message-id:reply-to;
        bh=vqtWTeMYfTgXU9PtJgEtafBxIuNX0sI2V7I6uzIL7HQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVY1lnTPPwfk2/H7A5H1ZshtuXeJVi5/bmrRsOgZ96dA5cxBXQK8wE3A1ExuzC4Y5/luRX2pO8602+J@vger.kernel.org
X-Gm-Message-State: AOJu0Yy5edle+K1svC6XoM8AguBuUwTwor/gTcGXJz/irIVhU2dG+Vg1
	CNuHF1vKL0oDAtoOnO0YtNi01WPh3VnDagZIk/5+2NfvN6LWtT64bRxk
X-Gm-Gg: 
X-Received: by 2002:a05:620a:4155:b0:8b2:ea3f:2f91 with SMTP id af79cd13be357-8c6f969032cmr533439385a.81.1769439189551;
        Mon, 26 Jan 2026 06:53:09 -0800 (PST)
Received: from wsfd-netdev58.anl.eng.rdu2.dc.redhat.com ([66.187.232.140])
        by smtp.gmail.com with ESMTPSA id af79cd13be357-8c6e37d2422sm1018611585a.18.2026.01.26.06.53.07
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 26 Jan 2026 06:53:08 -0800 (PST)
...
Subject: [PATCH net-next v8 08/15] quic: add path management
Date: Mon, 26 Jan 2026 09:51:06 -0500
Message-ID: <2367f77787fa0a29913f48c91087397dcc82c35f.1769439073.git.lucien.xin@gmail.com>
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-9123-lists,linux-cifs=lfdr.de];
...
new file mode 100644
index 000000000000..0adf07c73d01
--- /dev/null
+++ b/net/quic/path.h
@@ -0,0 +1,170 @@
+/* SPDX-License-Identifier: GPL-2.0-or-later */
...
index 68b5fc821537..a73364595b8e 100644
...
@@ -330,6 +331,12 @@ static __init int quic_init(void)
 	if (err)
 		goto err_hash;
...
+
 	...
 	if (err)
 		goto err_def_ops;
@@ -347,6 +354,8 @@ static __init int quic_init(void)
 err_protosw:
...
@@ -361,6 +370,8 @@ static __exit void quic_exit(void)
 #endif
 	quic_protosw_exit();
 	unregister_pernet_subsys(&quic_net_ops);
