Return-Path: <linux-cifs+bounces-1815-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 87EC68A2254
	for <lists+linux-cifs@lfdr.de>; Fri, 12 Apr 2024 01:34:05 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id CDE3A1F21AF1
	for <lists+linux-cifs@lfdr.de>; Thu, 11 Apr 2024 23:34:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AAA1647A79;
	Thu, 11 Apr 2024 23:34:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="UdRFgfBv"
X-Original-To: linux-cifs@vger.kernel.org
Received: from mail-qt1-f169.google.com (mail-qt1-f169.google.com [209.85.160.169])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A1D3B3FE54
	for <linux-cifs@vger.kernel.org>; Thu, 11 Apr 2024 23:33:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.169
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712878440; cv=none; b=Klqfy/rIbiGW7ssy2weHlnTtXHPZVoZjsY+PmiGRNJ3ZUp+V+cQX7JB522qqO8x3s4rmFGHG8D4h0GgKbiP6kwNqy5JhVikZiugcV3rdN4R0gtItyrAYwQbdVL8tMsuugYlqyrY0/aNwVcNt2WA1ay/fYBIQDgEqRaAHu7tOXAU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712878440; c=relaxed/simple;
	bh=42fPBRf7Dtr5zjl/bAJdchYYq2TtR/hUumUwGlaFt3c=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Content-Type; b=ekJlvuNzqAS84qqc9i1kEuQFqgepZlFmxJ6Jo3dhQ6Rk9YKR/i4cTo4knpJlpc31YOSIamXcib4m4yUTiK/k3xDPQzjI08zWqJjZ2LPGwluFaHGBLrM7BXqy8u/nlSlSozkwuNFxUms3XQqiq0AqCc4Bo9r3aLnY9XgZKqor/Y0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=UdRFgfBv; arc=none smtp.client-ip=209.85.160.169
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-qt1-f169.google.com with SMTP id d75a77b69052e-43477091797so56591cf.1
        for <linux-cifs@vger.kernel.org>; Thu, 11 Apr 2024 16:33:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1712878435; x=1713483235; darn=vger.kernel.org;
        h=to:subject:message-id:date:from:in-reply-to:references:mime-version
         :from:to:cc:subject:date:message-id:reply-to;
        bh=J4EkEARvKl1VHxj0XPjfLPCmPvIvnrhhnlJ01sQJBCc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712878435; x=1713483235;
        h=to:subject:message-id:date:from:in-reply-to:references:mime-version
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=J4EkEARvKl1VHxj0XPjfLPCmPvIvnrhhnlJ01sQJBCc=;
        b=
X-Gm-Message-State: AOJu0YxdlSlv3kJWlaokJsCZzJAqO05AnzCZWPDgl03DIgSBioalpXbx
	gIRFk8Sg22z5Hjh4317EU6jitpdYh0QsCbZvp5YkiJcMyOYlOFB8q4ZHRnGlNy0ljBNKyO04q1R
	PbsqOB4K/2VMUhec6n1tH9dA97T7Ls372Ry1dSj+6acTyG1mmow==
X-Google-Smtp-Source: AGHT+IEPt8rMw53ON2kOoZwQX0EQWx3J17WijmemB9Vo+P1IeuEnHgW7kqJosieeC3QvvkMMQm794YJTob6Is8T8Hxc=
X-Received: by 2002:a05:622a:a08:b0:434:3688:f093 with SMTP id
 bv8-20020a05622a0a0800b004343688f093mr56604qtb.27.1712878435136; Thu, 11 Apr
 2024 16:33:55 -0700 (PDT)
Precedence: bulk
...
Date: Thu, 11 Apr 2024 16:33:43 -0700
Message-ID: <CAOdxtTYn3AK+ndtBoU3Tsu8JO28egNHX14GW1QGV_aXFa=5LBQ@mail.gmail.com>
Subject: Re: kernel panic caused by recent changes in fs/cifs
To: linux-cifs@vger.kernel.org
Content-Type: multipart/mixed; boundary="000000000000ac080b0615da96ea"

--000000000000ac080b0615da96ea
...
On Thu, Apr 11, 2024 at 4:32=E2=80=AFPM Chenglong Tang <chenglongtang@googl=
e.com> wrote:
>
> Hi, developers,
>
...
>
> Deploy GKE Cluster with the same version as the customer v1.26.13-gke.114=
4000
> Deploy SMB CSI Driver Daemonset:
> https://github.com/kubernetes-csi/csi-driver-smb/blob/master/docs/install=
-csi-driver-v1.12.0.md
> Create SMB Server on the same cluster:
> https://github.com/kubernetes-csi/csi-driver-smb/tree/master/deploy/examp=
le/smb-provisioner
> Create Pod to create Client to create a PersistentVolume on the Samba
> Server in (3): https://github.com/kubernetes-csi/csi-driver-smb/blob/mast=
er/deploy/example/deployment.yaml
...
>
> image: gcr.io/iaas-gcr-reg-prd-ad3d/vendor/sig-storage/smbplugin:v1.12.0
> image: gcr.io/iaas-gcr-reg-prd-ad3d/vendor/sig-storage/livenessprobe:v2.1=
1.0
> image: gcr.io/iaas-gcr-reg-prd-ad3d/vendor/sig-storage/csi-provisioner:v3=
.6.0
...
>
> ded3cfd smb: client: fix OOB in smbCalcSize() by Paulo Alcantara =C2=B7 4=
 months ago
...
> bb08df4 smb3: fix caching of ctime on setxattr by Steve French =C2=B7 5 m=
onths ago
...
> 8d725bf cifs: spnego: add ';' in HOST_KEY_LEN by Anastasia Belova =C2=B7 =
5 months ago
...
>   23:   48 8b 05 9e d6 04 00    mov    0x4d69e(%rip),%rax        # 0x4d6c=
8
...
Content-ID: <f_luvvl2tl0>
X-Attachment-Id: f_luvvl2tl0
...
Content-Transfer-Encoding: base64
Content-ID: <f_luvvl2tr1>
X-Attachment-Id: f_luvvl2tr1
