...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 70700215B3E
	for <lists+linux-cifs@lfdr.de>; Mon,  6 Jul 2020 17:55:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729377AbgGFPzR (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Mon, 6 Jul 2020 11:55:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41070 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729364AbgGFPzP (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Mon, 6 Jul 2020 11:55:15 -0400
X-Greylist: delayed 1107 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Mon, 06 Jul 2020 08:55:14 PDT
Received: from hr2.samba.org (hr2.samba.org [IPv6:2a01:4f8:192:486::2:0])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D42FFC061755
        for <linux-cifs@vger.kernel.org>; Mon,  6 Jul 2020 08:55:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:To:CC;
        bh=rJHH8B2jEM7+rnIMOwP+6tA+pTFZy19Bw2u3omZJ9H0=; b=zGdubNxMV9ci5xcSqjvRvEOUwn
        
        /XUl01spoFE8xgW6cPY6yozg;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1jsTAj-00037F-1t; Mon, 06 Jul 2020 15:36:45 +0000
...
Subject: Re: [PATCH 1/7] cifs: merge __{cifs,smb2}_reconnect[_tcon]() into
 cifs_tree_connect()
Message-ID: <03f472c0-3c36-a28d-41bc-5b064b4ea16f@samba.org>
Date:   Mon, 6 Jul 2020 17:36:27 +0200
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="1BkSJi87tVMGPpX8B6LVxcWOMvRjhEDR2"
...
--1BkSJi87tVMGPpX8B6LVxcWOMvRjhEDR2
Content-Type: multipart/mixed; boundary="dHJLmnZ9Xi6CpP8bO0Buj5YtuyGWaej83";
...
--dHJLmnZ9Xi6CpP8bO0Buj5YtuyGWaej83
...
> +			rc =3D ops->tree_connect(xid, tcon->ses, tree, tcon, nlsc);
> +		} else {
> +			scnprintf(tree, MAX_TREE_SIZE, "\\%s", share);
> +			rc =3D ops->tree_connect(xid, tcon->ses, tree, tcon, nlsc);
> +			if (!rc) {
> +				rc =3D update_super_prepath(tcon, prefix, prefix_len);
> +				break;
> +			}
> +		}
...

=Cb2o
-----END PGP SIGNATURE-----
