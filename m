Return-Path: <linux-cifs+bounces-6181-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C3ADEB44860
	for <lists+linux-cifs@lfdr.de>; Thu,  4 Sep 2025 23:19:07 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5F438162AEE
	for <lists+linux-cifs@lfdr.de>; Thu,  4 Sep 2025 21:19:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 08067299947;
	Thu,  4 Sep 2025 21:19:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Epw1V8Wl"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B87C3267AF2
	for <linux-cifs@vger.kernel.org>; Thu,  4 Sep 2025 21:18:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1757020743; cv=none; b=nTo/b6+Z50z+IEe4tRqofMMbaPLXcNvtvluiiNxNUg4HfQjN8GXN3fIOcEULEGarIobs3jy9PprYtRsVyuPWLjrPCaj7Y6agysNQ/+lxdxc2SuGZbZ9w971AI+IAKwaEtCsIeV1C40X/X/Q4lXEiMHCUTpNtCTIYgEX0GJPzfGs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1757020743; c=relaxed/simple;
	bh=YPPt0KARhcJw8NoS+1sNC52arcwvU8K8j/LgCnE3bPE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=c7iqvFskMNLJqtOSl6rgnWnNnJg0SIGANXKDRB3MK30yOEHhwtDPUu+ikHX7RXt5AP6MdG6KbPKY5kqPUAbfdfZf48ku/YNvT6krYNqIyjPXTIwXGgbIXgLg9/xl1BdZRrw2b5MJJQjfreYwr2ZJqKtg6/34kivLuhgk4AIlyqI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Epw1V8Wl; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1757020736;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=Ai35Y4Udr4pSCq+Qsg5+iiqxvVh8aMnA0ubWYSz5V3k=;
	b=Epw1V8WlKSfx0iGzraa0ZrOu1z8fXGNvWZFhOMz3arbPkPKbjz9Bd61qPOuARp2xkFpzRf
	3nQAZcAupmqEbCo0x9aLLWHCjT1JOl2LMmrLxNpA/uJSlAZTK5CGOCXSW49QCMbqIKnaIo
	OfG79JMYTJxOZU+dDmil9oEBjDEsZf8=
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-433-J2hFN69LNqyn32ls9H5Mww-1; Thu,
 04 Sep 2025 17:18:53 -0400
X-MC-Unique: J2hFN69LNqyn32ls9H5Mww-1
X-Mimecast-MFC-AGG-ID: J2hFN69LNqyn32ls9H5Mww_1757020731
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 84DA31956089;
	Thu,  4 Sep 2025 21:18:51 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.6])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id B28F93002D27;
	Thu,  4 Sep 2025 21:18:48 +0000 (UTC)
...
Subject: [RFC PATCH 2/2] cifs: Clean up declarations
Date: Thu,  4 Sep 2025 22:18:33 +0100
Message-ID: <20250904211839.1152340-3-dhowells@redhat.com>
...
---
 ...
 fs/smb/client/cifsproto.h    | 1223 ++++++++++++++++------------------
 ...
 fs/smb/client/smb2proto.h    |  533 ++++++++-------
 fs/smb/client/smbdirect.h    |   27 +-
 23 files changed, 1101 insertions(+), 1130 deletions(-)

diff --git a/fs/smb/client/cached_dir.h b/fs/smb/client/cached_dir.h
index 46b5a2fdf15b..0c8b6b13ad4b 100644
...
index ce5cfd236fdb..38da0663304b 100644
...
index 3ce7c614ccc0..3c833e300442 100644
...
index f052e489e941..806ab1eb05cc 100644
...
@@ -1673,7 +1662,6 @@ static inline void cifs_stats_bytes_read(struct cifs_tcon *tcon,
...
@@ -1880,7 +1868,6 @@ static inline bool is_replayable_error(int error)
 	return false;
 }
...
@@ -2112,10 +2099,6 @@ extern unsigned int dir_cache_timeout; /* max time for directory lease caching o
...
index d9cf7db0ac35..5a5f378f58cc 100644
...
-
  ...
  */
@@ -708,7 +707,6 @@ struct ntlmv2_resp {
...
@@ -762,7 +760,6 @@ typedef struct smb_com_tconx_rsp_ext {
...
@@ -962,7 +959,6 @@ typedef struct smb_com_open_rsp_ext {
...
@@ -1427,7 +1423,6 @@ typedef struct smb_com_transaction_qsec_req {
 	__le32 AclFlags;
...
-
 typedef struct smb_com_transaction_ssec_req {
 	...
 	__u8 MaxSetupCount;
@@ -1622,7 +1617,6 @@ struct smb_t2_rsp {
...
-
 ...
 #define UNIX_FILE      0
 #define UNIX_DIR       1
@@ -2483,7 +2474,6 @@ struct file_attrib_tag {
 	__le32 ReparseTag;
...
-
 struct fea {
 	...
 	__u8 name_len;
@@ -2600,7 +2589,6 @@ struct data_blob {
...
index a4c8b350eaa4..6bba1b549ad6 100644
--- a/fs/smb/client/cifsproto.h
+++ b/fs/smb/client/cifsproto.h
@@ -19,20 +19,596 @@ struct statfs;
 struct smb_rqst;
 struct smb3_fs_context;
...
-						    void *page, bool prefix);
 ...
 {
 	return __getname();
@@ -74,61 +640,6 @@ static inline void free_dentry_path(void *page)
 		__putname(page);
 }
...
-
 ...
 send_cancel(struct TCP_Server_Info *server, struct smb_rqst *rqst,
 	    struct mid_q_entry *mid)
@@ -137,299 +648,6 @@ send_cancel(struct TCP_Server_Info *server, struct smb_rqst *rqst,
...
-
 struct cifs_unix_set_info_args {
 	__u64	ctime;
 	__u64	atime;
@@ -440,259 +658,8 @@ struct cifs_unix_set_info_args {
 	dev_t	device;
 };
...
@@ -704,14 +671,6 @@ static inline int get_dfs_path(const unsigned int xid, struct cifs_ses *ses,
 			      referral, NULL);
 }
...
-				   bool *islink);
 ...
 static inline int cifs_inval_name_dfs_link_error(const unsigned int xid,
 				   struct cifs_tcon *tcon,
@@ -732,8 +691,6 @@ static inline int cifs_create_options(struct cifs_sb_info *cifs_sb, int options)
 		return options;
 }
...
index 2a51c31d9387..fd9b67192c01 100644
...
index e60f0a24a8a1..4b9d2675509d 100644
...
index 18a08a2ca93b..8a106cd44111 100644
--- a/fs/smb/client/dfs_cache.h
+++ b/fs/smb/client/dfs_cache.h
@@ -33,24 +33,8 @@ struct dfs_cache_tgt_iterator {
...
index e2fa8ed24c54..152a53997558 100644
...
index 875de43b72de..be3825e26815 100644
...
index 66269c10beba..4465c6cc93eb 100644
...
index 68ab0447b671..d17b32046054 100644
...
index 3c09a58dfd07..ebde8938e226 100644
...
@@ -193,7 +192,6 @@ struct crt_sd_ctxt {
 	struct smb3_sd sd;
 } __packed;
...
index 6b0212ccd45c..840462363f1b 100644
...
+	    struct cifs_sb_info *cifs_sb, struct dentry *dentry);
 int smb2_rename_path(const unsigned int xid,
 		     struct cifs_tcon *tcon,
 		     struct dentry *source_dentry,
@@ -103,218 +76,242 @@ int smb2_create_hardlink(const unsigned int xid,
 			 struct dentry *source_dentry,
 			 const char *from_name, const char *to_name,
 			 struct cifs_sb_info *cifs_sb);
