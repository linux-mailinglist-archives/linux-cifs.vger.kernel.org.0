Return-Path: <linux-cifs+bounces-3380-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2ADF69C7C15
	for <lists+linux-cifs@lfdr.de>; Wed, 13 Nov 2024 20:21:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 6485DB246FA
	for <lists+linux-cifs@lfdr.de>; Wed, 13 Nov 2024 19:09:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 58DA2201261;
	Wed, 13 Nov 2024 19:09:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=permerror (0-bit key) header.d=darkrain42.org header.i=@darkrain42.org header.b="FZEPI2bP";
	dkim=pass (2048-bit key) header.d=darkrain42.org header.i=@darkrain42.org header.b="tqfvOgGy"
X-Original-To: linux-cifs@vger.kernel.org
Received: from o-chul.darkrain42.org (o-chul.darkrain42.org [74.207.241.14])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C04531FF7BD
	for <linux-cifs@vger.kernel.org>; Wed, 13 Nov 2024 19:09:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=74.207.241.14
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731524944; cv=none; b=n+xdSsq4Jhcqezu05kI3XBExFec57PTlAOqIVxERLl3l/SBRkU6Wu95P+qL5Uw+9D0zTYlc6AkDiEWwH5fVfmPpmZtrb4KUhRY3KLVAbwtLJBzkeU9tgusj6ALPyKCOGbYjwlTgH8SkriUw7k2EJnTAewtxSIxWIgmLdTs0U5yA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731524944; c=relaxed/simple;
	bh=ooVPClLtD4gAG8e6FbnxV3uHuXA3QLw9HYjBpfwwCmI=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=JydCOwpAXhPMRcWvRdozHPO5kOhuq/lRh9APmiEOwfNY9MCOFEoFME+ChvMfpXbaGHnvhH28jILbkEW+e76/CJ2R4FxLguxjV0lCKUtr/pkzuwBRQvlEqSl+T96D827q447uVc8E6sj2MCMfWhDLEgCBgI+hHq5ZBnnhcGXwc+s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=darkrain42.org; spf=pass smtp.mailfrom=darkrain42.org; dkim=permerror (0-bit key) header.d=darkrain42.org header.i=@darkrain42.org header.b=FZEPI2bP; dkim=pass (2048-bit key) header.d=darkrain42.org header.i=@darkrain42.org header.b=tqfvOgGy; arc=none smtp.client-ip=74.207.241.14
...
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed;
 ...
 t=1731524935; h=date : from : to : cc : subject : message-id :
 references : mime-version : content-type : content-transfer-encoding :
 in-reply-to : from; bh=fWAHpx6gQWW2NcQ8zn4s5HDHOrw918mJqV7+TWZJU8E=;
 b=FZEPI2bP1CmHz0GYC26I28ilJAaHOGsgBsKgUtafeKsLvMoFj3SmgI63G8X/9tY2U0U1l
 vIlUXNLeLxr0ImNAg==
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=darkrain42.org;
 i=@darkrain42.org; q=dns/txt; s=rsa-2022-03; t=1731524935; h=date :
 from : to : cc : subject : message-id : references : mime-version :
 content-type : content-transfer-encoding : in-reply-to : from;
 bh=fWAHpx6gQWW2NcQ8zn4s5HDHOrw918mJqV7+TWZJU8E=;
 b=
Received: from [127.0.0.1] (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256
	 client-signature ED25519)
	(Client CN "otters", Issuer "otters" (not verified))
	by o-chul.darkrain42.org (Postfix) with ESMTPS id 55A6480F0;
	Wed, 13 Nov 2024 11:08:55 -0800 (PST)
Received: by haley.home.arpa (Postfix, from userid 1000)
	id 8D57F35CCF; Wed, 13 Nov 2024 11:08:54 -0800 (PST)
Date: Wed, 13 Nov 2024 11:08:54 -0800
...
Message-ID: <ZzT5RlV3chHYYF8G@haley.home.arpa>
...
References: <20241108222906.3257172-1-paul@darkrain42.org>
 ...
 <igo6lqdjrldrgv5lq344yfsxrrgfwffdrxga3uh3umr324o3zb@icma7vfguafs>
 <CAH2r5muas7-EAyZa6LnaWNEtSc3MyB7TtGZrW=WgxRMUgb5e0Q@mail.gmail.com>
Precedence: bulk
