...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D9FD54F0CF6
	for <lists+linux-cifs@lfdr.de>; Mon,  4 Apr 2022 01:31:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376666AbiDCXdV (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Sun, 3 Apr 2022 19:33:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47210 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239505AbiDCXdU (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Sun, 3 Apr 2022 19:33:20 -0400
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 129D824BC8
        for <linux-cifs@vger.kernel.org>; Sun,  3 Apr 2022 16:31:24 -0700 (PDT)
Received: by mail-pg1-x529.google.com with SMTP id q19so6923240pgm.6
        for <linux-cifs@vger.kernel.org>; Sun, 03 Apr 2022 16:31:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=RJ2m7Shr7IwZIfyJF3r4kXOAQpR+BVM6t6nnSmi21BU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=RJ2m7Shr7IwZIfyJF3r4kXOAQpR+BVM6t6nnSmi21BU=;
        b=
X-Gm-Message-State: AOAM533GQVtQv5Gqg7fEj5HOLLbRgTKWfUv6Ij6hSZSlUaLVoHPYCn6P
        bvvGqJJreEu3pcPFrRN5NFoCkHyzmJX7Qg==
X-Google-Smtp-Source: ABdhPJxvxWe/QJIuuTC53z0c5VNbLTzCARbIQmKRiJcMcdDx1aaVQPkzOmTWY1Sp+81xSTxUZDZZHQ==
X-Received: by 2002:a63:3685:0:b0:398:49ba:648a with SMTP id d127-20020a633685000000b0039849ba648amr23298062pga.247.1649028682911;
        Sun, 03 Apr 2022 16:31:22 -0700 (PDT)
Received: from localhost.localdomain ([125.177.232.58])
        by smtp.googlemail.com with ESMTPSA id ev16-20020a17090aead000b001c7c2919453sm18763129pjb.33.2022.04.03.16.31.20
...
Subject: [PATCH] ksmbd: smbd: handle multiple Buffer Decriptors
Date:   Mon,  4 Apr 2022 08:30:56 +0900
Message-Id: <20220403233056.12693-1-hyc.lee@gmail.com>
...
index 3bf6c56c654c..9b91d1510684 100644
...
+			((char *)req + le32_to_cpu(req->ReadChannelInfoOffset));
 
-		if (ch_offset < offsetof(struct smb2_read_req, Buffer)) {
+		if (le32_to_cpu(req->ReadChannelInfoOffset) <
