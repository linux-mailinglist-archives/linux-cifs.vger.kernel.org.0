...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3498069F91
	for <lists+linux-cifs@lfdr.de>; Tue, 16 Jul 2019 01:40:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730429AbfGOXk0 (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Mon, 15 Jul 2019 19:40:26 -0400
Received: from mail-lj1-f193.google.com ([209.85.208.193]:42654 "EHLO
        mail-lj1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727379AbfGOXkZ (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Mon, 15 Jul 2019 19:40:25 -0400
Received: by mail-lj1-f193.google.com with SMTP id t28so18001110lje.9
        for <linux-cifs@vger.kernel.org>; Mon, 15 Jul 2019 16:40:21 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=I6KEpVpMsyu7HLJXxZv44J//wlRbJ8c0A/5XGzs6n38=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=I6KEpVpMsyu7HLJXxZv44J//wlRbJ8c0A/5XGzs6n38=;
        b=
X-Gm-Message-State: APjAAAXrUkp576SFjR4yk6YdSjxtLrSzn8rs7Yz50iMN4PLO+Fcz32Y8
        V+sNkjMxXoe0+IlT7Rp5nLFXExNMP1YGvXWMaw==
X-Google-Smtp-Source: APXvYqwuURLi27eR9ZSQK2ebsiyEGa2j6BADlpS7Pb9QH5kFZEQVFopv7oDqli6RpotpYE/8i+euyU6cb5ycn3oNAPE=
X-Received: by 2002:a2e:b167:: with SMTP id a7mr15992290ljm.26.1563234019891;
 Mon, 15 Jul 2019 16:40:19 -0700 (PDT)
MIME-Version: 1.0
References: <684ed01c-cbca-2716-bc28-b0a59a0f8521@prodrive-technologies.com>
 ...
 <CAKywueSgkKtWTw0TXvYhAmCR7zJDnE9toTDvZ_-0BM7bNy_f0A@mail.gmail.com> <8c1a4933-c42d-bb93-a3b3-41257a521c87@prodrive-technologies.com>
In-Reply-To: <8c1a4933-c42d-bb93-a3b3-41257a521c87@prodrive-technologies.com>
From:   Pavel Shilovsky <piastryyy@gmail.com>
Date:   Mon, 15 Jul 2019 16:40:08 -0700
Message-ID: <CAKywueQM3uSjEdoeWheek3AGwv_WhvNPSqODmVT2D03biO1sNg@mail.gmail.com>
...
=D0=B2=D1=82, 9 =D0=B8=D1=8E=D0=BB. 2019 =D0=B3. =D0=B2 01:48, Martijn de G=
ouw
...
>
> [706049.499153] kernel tried to execute NX-protected page - exploit attem=
pt? (uid: 0)
> [706049.499183] BUG: unable to handle kernel paging request at ffff8e6381=
d549d0
> [706049.499222] PGD 175c02067 P4D 175c02067 PUD 262470063 PMD 8000000101c=
000e3
> [706049.499245] Oops: 0011 [#1] PREEMPT SMP PTI
> [706049.499258] CPU: 0 PID: 77140 Comm: cifsd Tainted: G            E    =
 4.20.17-pd-4.20.y #20190611
> [706049.499280] Hardware name: VMware, Inc. VMware Virtual Platform/440BX=
 Desktop Reference Platform, BIOS 6.00 09/19/2018
> [706049.499320] RIP: 0010:0xffff8e6381d549d0
> [706049.499332] Code: ff ff 00 00 00 00 e2 04 00 00 00 7d 00 00 02 00 00 =
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 =
<d0> 49 d5 81 63 8e ff ff d0 49 d5 81 63 8e ff ff 00 91 36 88 63 8e
> [706049.499374] RSP: 0018:ffff9d2bd0c8bdc0 EFLAGS: 00010202
> [706049.499388] RAX: ffff8e6381d549d0 RBX: ffff8e659b599000 RCX: dead0000=
00000200
> [706049.499405] RDX: ffff8e66a9fe4280 RSI: 0000000000000246 RDI: ffff8e63=
81d54998
> [706049.499422] RBP: ffff8e66a9fe4280 R08: 0000000000000000 R09: ffff8e63=
81d54970
> [706049.499439] R10: ffff9d2bd0c8bc10 R11: ffff8e66a346c000 R12: ffff8e65=
9b5991c0
> [706049.499456] R13: ffff8e66a9fe4280 R14: ffff9d2bd0c8bdd8 R15: ffff8e66=
a9fe4900
> [706049.499473] FS:  0000000000000000(0000) GS:ffff8e66adc00000(0000) knl=
GS:0000000000000000
> [706049.499495] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> [706049.499516] CR2: ffff8e6381d549d0 CR3: 0000000427928002 CR4: 00000000=
003606f0
> [706049.499589] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00000000=
00000000
> [706049.499607] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00000000=
00000400
> [706049.499625] Call Trace:
> [706049.499934] CIFS VFS: No task to wake, unknown frame received! NumMid=
s 3
...
> [706049.502980] 00000020: 000002c3 00000001 00000905 00007400  ..........=
...t..
...
> [706049.505247] CIFS VFS: No task to wake, unknown frame received! NumMid=
s 3
> [706049.505681]  ? ret_from_fork+0x35/0x40
> [706049.506498] 00000000: 424d53fe 00010040 00000000 00000010  .SMB@.....=
......
> [706049.506926] Modules linked in: dm_snapshot(E) dm_bufio(E) cpufreq_use=
rspace(E) cpufreq_conservative(E) cpufreq_powersave(E) arc4(E) ecb(E) nfsv3=
(E) md4(E) nfs_acl(E) sha512_ssse3(E) nfs(E) sha512_generic(E) cmac(E) hmac=
(E) lockd(E) nls_utf8(E) cifs(E) grace(E) ccm(E) dns_resolver(E) fscache(E)=
 vmw_vsock_vmci_transport(E) vsock(E) sb_edac(E) crct10dif_pclmul(E) crc32_=
pclmul(E) ghash_clmulni_intel(E) vmwgfx(E) ttm(E) aesni_intel(E) drm_kms_he=
lper(E) aes_x86_64(E) crypto_simd(E) sg(E) cryptd(E) joydev(E) evdev(E) vmw=
_balloon(E) drm(E) glue_helper(E) vmw_vmci(E) serio_raw(E) ac(E) button(E) =
auth_rpcgss(E) sunrpc(E) ip_tables(E) x_tables(E) autofs4(E) ext4(E) crc32c=
_generic(E) crc16(E) mbcache(E) jbd2(E) dm_mod(E) sr_mod(E) cdrom(E) ata_ge=
neric(E) sd_mod(E) ata_piix(E) libata(E) vmw_pvscsi(E) crc32c_intel(E) psmo=
use(E) e1000e(E) scsi_mod(E) i2c_piix4(E)
> [706049.507729] 00000010: 00000005 00000068 0000046c 00000000  ....h...l.=
......
> [706049.508166] CR2: ffff8e6381d549d0
> [706049.508965] 00000020: 000002c3 00000001 00000905 00007400  ..........=
...t..
> [706049.513140] ---[ end trace e371dfb71e7921db ]---
> [706049.513143] RIP: 0010:0xffff8e6381d549d0
> [706049.513144] Code: ff ff 00 00 00 00 e2 04 00 00 00 7d 00 00 02 00 00 =
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 =
<d0> 49 d5 81 63 8e ff ff d0 49 d5 81 63 8e ff ff 00 91 36 88 63 8e
> [706049.513145] RSP: 0018:ffff9d2bd0c8bdc0 EFLAGS: 00010202
> [706049.513147] RAX: ffff8e6381d549d0 RBX: ffff8e659b599000 RCX: dead0000=
00000200
> [706049.513147] RDX: ffff8e66a9fe4280 RSI: 0000000000000246 RDI: ffff8e63=
81d54998
> [706049.513148] RBP: ffff8e66a9fe4280 R08: 0000000000000000 R09: ffff8e63=
81d54970
> [706049.513148] R10: ffff9d2bd0c8bc10 R11: ffff8e66a346c000 R12: ffff8e65=
9b5991c0
> [706049.513149] R13: ffff8e66a9fe4280 R14: ffff9d2bd0c8bdd8 R15: ffff8e66=
a9fe4900
> [706049.513150] FS:  0000000000000000(0000) GS:ffff8e66adc00000(0000) knl=
GS:0000000000000000
> [706049.513151] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> [706049.513151] CR2: ffff8e6381d549d0 CR3: 0000000427928002 CR4: 00000000=
003606f0
> [706049.513201] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00000000=
00000000
> [706049.521671] 00000030: 00000000 00000000 00000000 00000000  ..........=
......
> [706049.522058] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00000000=
00000400
> [706049.523846] CIFS VFS: No task to wake, unknown frame received! NumMid=
s 3
...
......
> [706049.526449] 00000020: 000002c3 00000001 00000905 00007400  ..........=
...t..
> [706049.527304] 00000030: 00000000 00000000 00000000 00000000  ..........=
......
> [707493.825696] CIFS VFS: Server stor02.bk.prodrive.nl has not responded =
in 120 seconds. Reconnecting...
> [707615.670866] CIFS VFS: Server stor02.bk.prodrive.nl has not responded =
in 120 seconds. Reconnecting...
> [707737.516154] CIFS VFS: Server stor02.bk.prodrive.nl has not responded =
in 120 seconds. Reconnecting...
>
> Regards, Martijn
>
> On 06-07-2019 18:40, Pavel Shilovsky wrote:
> > Martijn, thanks for the traces. This is a deadlock as mentioned by Aure=
lien:
> >
> > [36247.368103] INFO: task puppet:3836 blocked for more than 120 seconds=
.
> > [36247.368119]       Tainted: G            E     4.20.17-pd-4.20.y #201=
90611
...
> > [36247.368294]  ? build_path_from_dentry_optional_prefix+0x1e9/0x440 [c=
ifs]
...
> > functions.
> >
> > You can try to work around this by specifying "nohandlecache" mount opt=
ion.
> >
> > --
> > Best regards,
> > Pavel Shilovsky
> >
> > =D1=81=D0=B1, 6 =D0=B8=D1=8E=D0=BB. 2019 =D0=B3. =D0=B2 06:05, Steve Fr=
...
> >>>> the kernel?
> >>>
> >>> I can try to run them for a while on a less critical server. But even=
 if that machine runs fine, there is not really a guarantee the cifs issue =
we have right now is solved for our critical machines, causing me to be ver=
y hesitated to upgrade those.
> >>>
> >>> Btw, here is another kernel dump, generated today. Please note that o=
n this machine the cifs mounts are not really used, all 'action'
> >>> performed on these mounts is the check if they are still mounted (by =
puppet).
> >>>
> >>>
> >>> [36247.367572] INFO: task node_exporter:3567 blocked for more than 12=
0 seconds.
> >>> [36247.367613]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36247.367630] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36247.367937] RSP: 002b:000000c0003ef490 EFLAGS: 00000206 ORIG_RAX: =
0000000000000089
> >>> [36247.367938] RAX: ffffffffffffffda RBX: 000000c00002a000 RCX: 00000=
000004a5c20
> >>> [36247.367939] RDX: 0000000000000000 RSI: 000000c0003ef5c0 RDI: 00000=
0c0004510e0
> >>> [36247.367940] RBP: 000000c0003ef4f0 R08: 0000000000000000 R09: 00000=
00000000000
> >>> [36247.367940] R10: 0000000000000000 R11: 0000000000000206 R12: fffff=
fffffffffff
> >>> [36247.367941] R13: 0000000000000088 R14: 0000000000000087 R15: 00000=
00000000100
> >>> [36247.367954] INFO: task kworker/1:2:32265 blocked for more than 120=
 seconds.
> >>> [36247.367973]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36247.367989] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36247.368037]  ? SMB2_sess_auth_rawntlmssp_authenticate+0x69/0x170 [=
cifs]
...
> >>> [36247.368103] INFO: task puppet:3836 blocked for more than 120 secon=
ds.
> >>> [36247.368119]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36247.368135] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
> >>> [36247.368158] puppet          D    0  3836    541 0x00000000
> >>> [36247.368159] Call Trace:
> >>> [36247.368161]  ? __schedule+0x338/0x850
...
> >>> [36247.368278]  cifs_get_inode_info+0x580/0xb10 [cifs]
> >>> [36247.368286]  ? filename_lookup+0xf8/0x1a0
> >>> [36247.368294]  ? build_path_from_dentry_optional_prefix+0x1e9/0x440 =
[cifs]
> >>> [36247.368303]  cifs_revalidate_dentry_attr+0xdc/0x3e0 [cifs]
> >>> [36247.368311]  cifs_getattr+0x5b/0x1b0 [cifs]
> >>> [36247.368313]  vfs_statx+0x89/0xe0
...
> >>> [36247.368321] RIP: 0033:0x7f562d3a0335
> >>> [36247.368323] Code: Bad RIP value.
> >>> [36247.368324] RSP: 002b:00007ffc6bbc4398 EFLAGS: 00000246 ORIG_RAX: =
0000000000000006
> >>> [36247.368325] RAX: ffffffffffffffda RBX: 00007ffc6bbc43b0 RCX: 00007=
f562d3a0335
> >>> [36247.368326] RDX: 00007ffc6bbc43b0 RSI: 00007ffc6bbc43b0 RDI: 00005=
5e4e5e1bd50
> >>> [36247.368326] RBP: 000055e4e2eb65e0 R08: 0000000000000002 R09: 00005=
5e4e2eb69e0
> >>> [36247.368327] R10: 0000000000000000 R11: 0000000000000246 R12: 00000=
00000000001
> >>> [36247.368328] R13: 000055e4e2ef7258 R14: 000055e4e2ef8810 R15: 00005=
5e4e2f92ad0
> >>> [36368.186922] INFO: task node_exporter:3567 blocked for more than 12=
0 seconds.
> >>> [36368.186988]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36368.187039] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36368.187519] RSP: 002b:000000c0003ef490 EFLAGS: 00000206 ORIG_RAX: =
0000000000000089
> >>> [36368.187523] RAX: ffffffffffffffda RBX: 000000c00002a000 RCX: 00000=
000004a5c20
> >>> [36368.187526] RDX: 0000000000000000 RSI: 000000c0003ef5c0 RDI: 00000=
0c0004510e0
> >>> [36368.187528] RBP: 000000c0003ef4f0 R08: 0000000000000000 R09: 00000=
00000000000
> >>> [36368.187530] R10: 0000000000000000 R11: 0000000000000206 R12: fffff=
fffffffffff
> >>> [36368.187532] R13: 0000000000000088 R14: 0000000000000087 R15: 00000=
00000000100
> >>> [36368.187572] INFO: task kworker/1:2:32265 blocked for more than 120=
 seconds.
> >>> [36368.187627]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36368.187677] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36368.187826]  ? SMB2_sess_auth_rawntlmssp_authenticate+0x69/0x170 [=
cifs]
...
> >>> [36368.188014] INFO: task puppet:3836 blocked for more than 120 secon=
ds.
> >>> [36368.188064]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36368.188114] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36368.188601]  ? build_path_from_dentry_optional_prefix+0x1e9/0x440 =
[cifs]
...
> >>> [36368.188691] RSP: 002b:00007ffc6bbc4398 EFLAGS: 00000246 ORIG_RAX: =
0000000000000006
> >>> [36368.188695] RAX: ffffffffffffffda RBX: 00007ffc6bbc43b0 RCX: 00007=
f562d3a0335
> >>> [36368.188696] RDX: 00007ffc6bbc43b0 RSI: 00007ffc6bbc43b0 RDI: 00005=
5e4e5e1bd50
> >>> [36368.188698] RBP: 000055e4e2eb65e0 R08: 0000000000000002 R09: 00005=
5e4e2eb69e0
> >>> [36368.188700] R10: 0000000000000000 R11: 0000000000000246 R12: 00000=
00000000001
> >>> [36368.188702] R13: 000055e4e2ef7258 R14: 000055e4e2ef8810 R15: 00005=
5e4e2f92ad0
> >>> [36489.006262] INFO: task node_exporter:3567 blocked for more than 12=
0 seconds.
> >>> [36489.006300]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36489.006329] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36489.006655] RSP: 002b:000000c0003ef490 EFLAGS: 00000206 ORIG_RAX: =
0000000000000089
> >>> [36489.006657] RAX: ffffffffffffffda RBX: 000000c00002a000 RCX: 00000=
000004a5c20
> >>> [36489.006658] RDX: 0000000000000000 RSI: 000000c0003ef5c0 RDI: 00000=
0c0004510e0
> >>> [36489.006659] RBP: 000000c0003ef4f0 R08: 0000000000000000 R09: 00000=
00000000000
> >>> [36489.006660] R10: 0000000000000000 R11: 0000000000000206 R12: fffff=
fffffffffff
> >>> [36489.006661] R13: 0000000000000088 R14: 0000000000000087 R15: 00000=
00000000100
> >>> [36489.006675] INFO: task kworker/1:2:32265 blocked for more than 120=
 seconds.
> >>> [36489.006812]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36489.006940] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36489.007124]  ? SMB2_sess_auth_rawntlmssp_authenticate+0x69/0x170 [=
cifs]
...
> >>> [36489.007186] INFO: task puppet:3836 blocked for more than 120 secon=
ds.
> >>> [36489.007294]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36489.007409] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36489.007762]  ? build_path_from_dentry_optional_prefix+0x1e9/0x440 =
[cifs]
...
> >>> [36489.007809] RSP: 002b:00007ffc6bbc4398 EFLAGS: 00000246 ORIG_RAX: =
0000000000000006
> >>> [36489.007811] RAX: ffffffffffffffda RBX: 00007ffc6bbc43b0 RCX: 00007=
f562d3a0335
> >>> [36489.007812] RDX: 00007ffc6bbc43b0 RSI: 00007ffc6bbc43b0 RDI: 00005=
5e4e5e1bd50
> >>> [36489.007813] RBP: 000055e4e2eb65e0 R08: 0000000000000002 R09: 00005=
5e4e2eb69e0
> >>> [36489.007814] R10: 0000000000000000 R11: 0000000000000246 R12: 00000=
00000000001
> >>> [36489.007815] R13: 000055e4e2ef7258 R14: 000055e4e2ef8810 R15: 00005=
5e4e2f92ad0
> >>> [36609.825705] INFO: task node_exporter:3567 blocked for more than 12=
0 seconds.
> >>> [36609.825836]       Tainted: G            E     4.20.17-pd-4.20.y #2=
0190611
> >>> [36609.825869] "echo 0 > /proc/sys/kernel/hung_task_timeout_secs" dis=
ables this message.
...
> >>> [36609.826124] RSP: 002b:000000c0003ef490 EFLAGS: 00000206 ORIG_RAX: =
0000000000000089
> >>> [36609.826126] RAX: ffffffffffffffda RBX: 000000c00002a000 RCX: 00000=
000004a5c20
> >>> [36609.826127] RDX: 0000000000000000 RSI: 000000c0003ef5c0 RDI: 00000=
0c0004510e0
> >>> [36609.826128] RBP: 000000c0003ef4f0 R08: 0000000000000000 R09: 00000=
00000000000
> >>> [36609.826129] R10: 0000000000000000 R11: 0000000000000206 R12: fffff=
fffffffffff
> >>> [36609.826130] R13: 0000000000000088 R14: 0000000000000087 R15: 00000=
00000000100
> >>> [73117.654990] CIFS VFS: Send error in SessSetup =3D -126
> >>>
> >>> Regards, Martijn
> >>>
> >>>>
...
> >>>> Pavel Shilovsky
> >>>>
> >>>> =D1=87=D1=82, 4 =D0=B8=D1=8E=D0=BB. 2019 =D0=B3. =D0=B2 06:36, Marti=
jn de Gouw
> >>>> <martijn.de.gouw@prodrive-technologies.com>:
> >>>>>
> >>>>> Hi,
...
:
> >>>>>>>> Are there any kernel oops/panic with stack traces and register d=
umps in
> >>>>>>>> the log?
> >>>>>>>>
> >>>>>>>> You can inspect the kernel stack trace of the hung processes (to=
 see where
> >>>>>>>> they are stuck) by printing the file /proc/<pid>/stack.
> >>>>>>>
> >>>>>>> These are the stacks of all processes that are D, most of them be=
ing df.
> >>>>>>> I also attached the cifs Stats output below.
> >>>>>>
> >>>>>> Ok thanks. What about Oops or BUG or panic in dmesg logs, did you =
see
> >>>>>> any?
> >>>>>
> >>>>> I did find the following messages in the dmesg of one of the server=
s:
> >>>>>
> >>>>> [    4.797893] FS-Cache: Duplicate cookie detected
> >>>>> [    4.797915] FS-Cache: O-cookie c=3D000000001a791554 [p=3D0000000=
0fb6f31ee fl=3D222 nc=3D0 na=3D1]
> >>>>> [    4.797934] FS-Cache: O-cookie d=3D0000000020a06fab n=3D00000000=
654600e7
> >>>>> [    4.797949] FS-Cache: O-key=3D[8] '020001bd0a010102'
> >>>>> [    4.797963] FS-Cache: N-cookie c=3D000000005d0bf4a5 [p=3D0000000=
0fb6f31ee fl=3D2 nc=3D0 na=3D1]
> >>>>> [    4.797982] FS-Cache: N-cookie d=3D0000000020a06fab n=3D00000000=
4e1e47aa
> >>>>> [    4.797997] FS-Cache: N-key=3D[8] '020001bd0a010102'
> >>>>> [    4.798643] FS-Cache: Duplicate cookie detected
> >>>>> [    4.798659] FS-Cache: O-cookie c=3D000000001a791554 [p=3D0000000=
0fb6f31ee fl=3D222 nc=3D0 na=3D1]
> >>>>> [    4.798679] FS-Cache: O-cookie d=3D0000000020a06fab n=3D00000000=
654600e7
> >>>>> [    4.798695] FS-Cache: O-key=3D[8] '020001bd0a010102'
> >>>>> [    4.798714] FS-Cache: N-cookie c=3D00000000cbe44971 [p=3D0000000=
0fb6f31ee fl=3D2 nc=3D0 na=3D1]
> >>>>> [    4.798733] FS-Cache: N-cookie d=3D0000000020a06fab n=3D00000000=
ab0e78a6
...
> >>>>> [250515.749714] kernel tried to execute NX-protected page - exploit=
 attempt? (uid: 0)
> >>>>> [250515.749740] BUG: unable to handle kernel paging request at ffff=
8ec52a6fe1d0
> >>>>> [250515.749757] PGD 1b2602067 P4D 1b2602067 PUD 42dbff063 PMD 42a35=
7063 PTE 800000042a6fe063
> >>>>> [250515.749779] Oops: 0011 [#1] PREEMPT SMP PTI
> >>>>> [250515.749792] CPU: 1 PID: 796 Comm: cifsd Tainted: G            E=
     4.20.17-pd-4.20.y #20190611
> >>>>> [250515.749812] Hardware name: VMware, Inc. VMware Virtual Platform=
/440BX Desktop Reference Platform, BIOS 6.00 09/19/2018
> >>>>> [250515.749844] RIP: 0010:0xffff8ec52a6fe1d0
> >>>>> [250515.749860] Code: ff ff 00 00 00 00 fd 01 00 00 00 7d 00 00 01 =
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 =
00 00 <d0> e1 6f 2a c5 8e ff ff d0 e1 6f 2a c5 8e ff ff 80 70 82 2b c5 8e
> >>>>> [250515.749914] RSP: 0018:ffff9e60c2e2bdc0 EFLAGS: 00010202
> >>>>> [250515.749927] RAX: ffff8ec52a6fe1d0 RBX: ffff8ec526fce800 RCX: de=
ad000000000200
> >>>>> [250515.749944] RDX: ffff8ec52d3e6800 RSI: 0000000000000246 RDI: ff=
ff8ec52a6fe198
> >>>>> [250515.749962] RBP: ffff8ec52d3e6800 R08: 0000000000000002 R09: ff=
ff8ec52a6fe170
> >>>>> [250515.749979] R10: ffff9e60c2e2bc10 R11: ffff8ec527088000 R12: ff=
ff8ec526fce9c0
> >>>>> [250515.749997] R13: ffff8ec52d3e6800 R14: ffff9e60c2e2bdd8 R15: ff=
ff8ec52d3e6b80
> >>>>> [250515.750014] FS:  0000000000000000(0000) GS:ffff8ec52fa80000(000=
0) knlGS:0000000000000000
> >>>>> [250515.750033] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> >>>>> [250515.750048] CR2: ffff8ec52a6fe1d0 CR3: 000000042a53c005 CR4: 00=
000000003606e0
> >>>>> [250515.750100] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00=
00000000000000
> >>>>> [250515.750102] CIFS VFS: No task to wake, unknown frame received! =
NumMids 3
> >>>>> [250515.750119] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00=
00000000000400
...
> >>>>> [250515.750271] 00000030: 5a9e63f3 6204a9b0 587058e3 0d45419b  .c.Z=
...b.XpX.AE.
> >>>>> [250515.750295]  ? cifs_handle_standard+0x190/0x190 [cifs]
> >>>>> [250515.750728] CIFS VFS: No task to wake, unknown frame received! =
NumMids 3
...
.......d....
> >>>>> [250515.753874] Modules linked in: cpufreq_userspace(E) cpufreq_pow=
ersave(E) cpufreq_conservative(E) arc4(E) ecb(E) md4(E) nfsv3(E) nfs_acl(E)=
 nfs(E) sha512_ssse3(E) sha512_generic(E) lockd(E) cmac(E) grace(E) hmac(E)=
 nls_utf8(E) cifs(E) ccm(E) dns_resolver(E) fscache(E) vmw_vsock_vmci_trans=
port(E) vsock(E) sb_edac(E) crct10dif_pclmul(E) crc32_pclmul(E) ghash_clmul=
ni_intel(E) aesni_intel(E) vmw_balloon(E) aes_x86_64(E) joydev(E) evdev(E) =
crypto_simd(E) vmwgfx(E) serio_raw(E) cryptd(E) glue_helper(E) ttm(E) sg(E)=
 vmw_vmci(E) drm_kms_helper(E) drm(E) button(E) ac(E) auth_rpcgss(E) sunrpc=
(E) ip_tables(E) x_tables(E) autofs4(E) ext4(E) crc32c_generic(E) crc16(E) =
mbcache(E) jbd2(E) sr_mod(E) cdrom(E) ata_generic(E) sd_mod(E) ata_piix(E) =
crc32c_intel(E) psmouse(E) libata(E) vmw_pvscsi(E) vmxnet3(E) scsi_mod(E) i=
2c_piix4(E)
> >>>>> [250515.754336] 00000030: 49d4fd21 858665a2 fde5288f 01d2d919  !..I=
.e...(......
> >>>>> [250515.754766] CR2: ffff8ec52a6fe1d0
> >>>>> [250515.758927] CIFS VFS: No task to wake, unknown frame received! =
NumMids 3
...
> >>>>> [250515.761841] Code: ff ff 00 00 00 00 fd 01 00 00 00 7d 00 00 01 =
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 =
00 00 <d0> e1 6f 2a c5 8e ff ff d0 e1 6f 2a c5 8e ff ff 80 70 82 2b c5 8e
> >>>>> [250515.763287] RSP: 0018:ffff9e60c2e2bdc0 EFLAGS: 00010202
> >>>>> [250515.763778] RAX: ffff8ec52a6fe1d0 RBX: ffff8ec526fce800 RCX: de=
ad000000000200
> >>>>> [250515.764060] 00000010: 0000000d 00000000 00000db4 00000000  ....=
............
> >>>>> [250515.764310] RDX: ffff8ec52d3e6800 RSI: 0000000000000246 RDI: ff=
ff8ec52a6fe198
> >>>>> [250515.764311] RBP: ffff8ec52d3e6800 R08: 0000000000000002 R09: ff=
ff8ec52a6fe170
> >>>>> [250515.764312] R10: ffff9e60c2e2bc10 R11: ffff8ec527088000 R12: ff=
ff8ec526fce9c0
> >>>>> [250515.764314] R13: ffff8ec52d3e6800 R14: ffff9e60c2e2bdd8 R15: ff=
ff8ec52d3e6b80
> >>>>> [250515.765491] 00000020: 0000025c 00000001 640002e9 0000c81d  \...=
.......d....
> >>>>> [250515.765836] FS:  0000000000000000(0000) GS:ffff8ec52fa80000(000=
0) knlGS:0000000000000000
> >>>>> [250515.767899] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> >>>>> [250515.768367] CR2: ffff8ec52a6fe1d0 CR3: 000000042a53c005 CR4: 00=
000000003606e0
> >>>>> [250515.768919] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00=
00000000000000
> >>>>> [250515.769419] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00=
00000000000400
> >>>>> [250515.769591] 00000030: 879543e1 572c0574 e53861ba 97ccc40b  .C..=
t.,W.a8.....
...
> >>>>> [    4.253120] FS-Cache: O-cookie c=3D000000004cc29d26 [p=3D0000000=
017dbbbc0 fl=3D222 nc=3D0 na=3D1]
> >>>>> [    4.253153] FS-Cache: O-cookie d=3D00000000e8e68765 n=3D00000000=
12869fa7
> >>>>> [    4.253179] FS-Cache: O-key=3D[8] '020001bd0a010102'
> >>>>> [    4.253201] FS-Cache: N-cookie c=3D00000000c3bbbddd [p=3D0000000=
017dbbbc0 fl=3D2 nc=3D0 na=3D1]
> >>>>> [    4.253235] FS-Cache: N-cookie d=3D00000000e8e68765 n=3D00000000=
335882b3
> >>>>> [    4.253262] FS-Cache: N-key=3D[8] '020001bd0a010102'
> >>>>> [    4.254107] FS-Cache: Duplicate cookie detected
> >>>>> [    4.254130] FS-Cache: O-cookie c=3D000000004cc29d26 [p=3D0000000=
017dbbbc0 fl=3D222 nc=3D0 na=3D1]
> >>>>> [    4.254161] FS-Cache: O-cookie d=3D00000000e8e68765 n=3D00000000=
12869fa7
> >>>>> [    4.254185] FS-Cache: O-key=3D[8] '020001bd0a010102'
> >>>>> [    4.254230] FS-Cache: N-cookie c=3D000000000ec2f0bb [p=3D0000000=
017dbbbc0 fl=3D2 nc=3D0 na=3D1]
> >>>>> [    4.254261] FS-Cache: N-cookie d=3D00000000e8e68765 n=3D00000000=
24706210
> >>>>> [    4.254285] FS-Cache: N-key=3D[8] '020001bd0a010102'
> >>>>> [    4.329147] CIFS VFS: BAD_NETWORK_NAME: \\stor02.bk.prodrive.nl\=
userdata$
...
> >>>>> [402750.869518] kernel tried to execute NX-protected page - exploit=
 attempt? (uid: 0)
> >>>>> [402750.869594] BUG: unable to handle kernel paging request at ffff=
909bf61609d0
> >>>>> [402750.869650] PGD 1ac02067 P4D 1ac02067 PUD 1385f5063 PMD 1361420=
63 PTE 8000000136160063
> >>>>> [402750.869716] Oops: 0011 [#1] PREEMPT SMP PTI
> >>>>> [402750.869753] CPU: 0 PID: 797 Comm: cifsd Tainted: G            E=
     4.20.17-pd-4.20.y #20190611
> >>>>> [402750.869818] Hardware name: VMware, Inc. VMware Virtual Platform=
/440BX Desktop Reference Platform, BIOS 6.00 09/19/2018
> >>>>> [402750.869926] CIFS VFS: No task to wake, unknown frame received! =
NumMids 3
> >>>>> [402750.869947] RIP: 0010:0xffff909bf61609d0
> >>>>> [402750.870013] 00000000: 424d53fe 00010040 00000000 00000005  .SMB=
@...........
> >>>>> [402750.870198] Code: ff ff 00 00 00 00 4e 01 00 00 00 7d 00 00 03 =
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 =
00 00 <d0> 09 16 f6 9b 90 ff ff d0 09 16 f6 9b 90 ff ff c0 40 1f f2 9b 90
...
.......D$...
> >>>>> [402750.870509] RAX: ffff909bf61609d0 RBX: ffff909bf6c3f800 RCX: de=
ad000000000200
> >>>>> [402750.870511] RDX: ffff909bf74fa980 RSI: 0000000000000246 RDI: ff=
ff909bf6160998
> >>>>> [402750.870530] 00000030: 79955e4a 0dacb8eb 025edebd 4efa7788  J^.y=
......^..w.N
> >>>>> [402750.870582] RBP: ffff909bf74fa980 R08: 0000000000000000 R09: ff=
ff909bf6c3f970
> >>>>> [402750.870585] R10: ffffa18d406a7cc0 R11: 0000000000000000 R12: ff=
ff909bf6c3f9c0
> >>>>> [402750.870605] CIFS VFS: No task to wake, unknown frame received! =
NumMids 3
> >>>>> [402750.870656] R13: ffff909bf74fa980 R14: ffffa18d41adbd40 R15: ff=
ff909bf74fa100
> >>>>> [402750.870660] FS:  0000000000000000(0000) GS:ffff909bf9c00000(000=
0) knlGS:0000000000000000
> >>>>> [402750.870677] 00000000: 424d53fe 00010040 00000000 00000010  .SMB=
@...........
> >>>>> [402750.870731] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> >>>>> [402750.870733] CR2: ffff909bf61609d0 CR3: 0000000136e56004 CR4: 00=
000000003606f0
> >>>>> [402750.870752] 00000010: 0000000d 00000068 000002b6 00000000  ....=
h...........
> >>>>> [402750.870888] 00000020: 000001cd 00000001 44000cd9 0000c824  ....=
.......D$...
> >>>>> [402750.870894] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00=
00000000000000
> >>>>> [402750.870907] 00000030: f063942a cae9f6e1 d5327c26 91fc6f33  *.c.=
....&|2.3o..
> >>>>> [402750.872321] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00=
00000000000400
...
> >>>>> [402750.879786] Modules linked in: cpufreq_conservative(E) cpufreq_=
powersave(E) cpufreq_userspace(E) arc4(E) ecb(E) md4(E) sha512_ssse3(E) sha=
512_generic(E) cmac(E) hmac(E) nfsv3(E) nfs_acl(E) nls_utf8(E) nfs(E) lockd=
(E) grace(E) cifs(E) ccm(E) dns_resolver(E) fscache(E) sb_edac(E) crct10dif=
_pclmul(E) crc32_pclmul(E) ghash_clmulni_intel(E) aesni_intel(E) aes_x86_64=
(E) crypto_simd(E) joydev(E) cryptd(E) vmw_balloon(E) evdev(E) glue_helper(=
E) serio_raw(E) vmwgfx(E) ttm(E) drm_kms_helper(E) sg(E) drm(E) vmw_vsock_v=
mci_transport(E) vsock(E) vmw_vmci(E) ac(E) button(E) auth_rpcgss(E) sunrpc=
(E) ip_tables(E) x_tables(E) autofs4(E) ext4(E) crc32c_generic(E) crc16(E) =
mbcache(E) jbd2(E) sr_mod(E) cdrom(E) sd_mod(E) ata_generic(E) ata_piix(E) =
vmw_pvscsi(E) libata(E) crc32c_intel(E) psmouse(E) vmxnet3(E) i2c_piix4(E) =
scsi_mod(E)
> >>>>> [402750.883384] CR2: ffff909bf61609d0
> >>>>> [402750.883783] ---[ end trace 08b06875e82513eb ]---
> >>>>> [402750.884200] RIP: 0010:0xffff909bf61609d0
> >>>>> [402750.884598] Code: ff ff 00 00 00 00 52 01 00 00 00 7d 00 00 02 =
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 =
00 00 <d0> 09 16 f6 9b 90 ff ff d0 09 16 f6 9b 90 ff ff c0 40 1f f2 9b 90
> >>>>> [402750.885822] RSP: 0000:ffffa18d41adbd28 EFLAGS: 00010202
> >>>>> [402750.886229] RAX: ffff909bf61609d0 RBX: ffff909bf6c3f800 RCX: de=
ad000000000200
> >>>>> [402750.886651] RDX: ffff909bf74fa980 RSI: 0000000000000246 RDI: ff=
ff909bf6160998
> >>>>> [402750.887065] RBP: ffff909bf74fa980 R08: 0000000000000000 R09: ff=
ff909bf6c3f970
> >>>>> [402750.887478] R10: ffffa18d406a7cc0 R11: 0000000000000000 R12: ff=
ff909bf6c3f9c0
> >>>>> [402750.887883] R13: ffff909bf74fa980 R14: ffffa18d41adbd40 R15: ff=
ff909bf74fa100
> >>>>> [402750.888285] FS:  0000000000000000(0000) GS:ffff909bf9c00000(000=
0) knlGS:0000000000000000
> >>>>> [402750.888692] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> >>>>> [402750.889093] CR2: ffff909bf61609d0 CR3: 0000000136e56004 CR4: 00=
000000003606f0
> >>>>> [402750.889559] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 00=
00000000000000
> >>>>> [402750.889972] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 00=
00000000000400
...
> >>>>>>
> >>>>>>> pid: 9505
> >>>>>>> syscall: 4 0x56550a2ec470 0x7ffede42e9a0 0x7ffede42e9a0 0x83a 0x3=
 0x20
> >>>>>>> 0x7ffede42e8f8 0x7f7f8928f295
> >>>>>>> [<0>] open_shroot+0x43/0x200 [cifs]
> >>>>>>> [<0>] smb2_query_path_info+0x93/0x220 [cifs]
> >>>>>>
> >>>>>> Almost all of the processes have the same stack trace. They are st=
uck at
> >>>>>> open_shroot()+0x43 which is probably
> >>>>>>
> >>>>>>        mutex_lock(&tcon->crfid.fid_mutex);
> >>>>>>
> >>>>>> Then there are only 2 other processes stuck somewhere in the same =
code path
> >>>>>> (open_shroot) but deeper, meaning they have the locks that the oth=
er
> >>>>>> processes are waiting for:
> >>>>>>
> >>>>>>
> >>>>>>> pid: 22858
> >>>>>>> syscall: 4 0x564b46285d10 0x7ffcea3f9a80 0x7ffcea3f9a80 0x83a 0x3=
 0x20
...
> >>>>>>                    open_file =3D list_entry(tmp, struct cifsFileIn=
fo, tlist);
...
> >>>>>>
> >>>>>>            mutex_lock(&tcon->crfid.fid_mutex); <=3D=3D=3D most lik=
ely here
> >>>>>>            tcon->crfid.is_valid =3D false;
> >>>>>>            memset(tcon->crfid.fid, 0, sizeof(struct cifs_fid));
> >>>>>>            mutex_unlock(&tcon->crfid.fid_mutex);
> >>>>>>
> >>>>>> I think these processes are trying to lock the same lock twice: on=
e in
> >>>>>> open_shroot() and since Open ends up having to reconnect, once aga=
in in
> >>>>>> mark_open_files_invalid(). I think it's the same lock because I do=
n't
> >>>>>> see why the tcon pointers would be different in those 2 spots. Ker=
nel
> >>>>>> mutexes are not reentrant so this is a deadlock.
> >>>>>
> >>>>> Is there anything we can do about this? Is this maybe already fixed=
 in newer kernels?
> >>>>>
> >>>>> Regards, Martijn
> >>>>>
