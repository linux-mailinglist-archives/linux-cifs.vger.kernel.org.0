Return-Path: <linux-cifs+bounces-8081-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B9BBC9979F
	for <lists+linux-cifs@lfdr.de>; Mon, 01 Dec 2025 23:59:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 20DE24E2BAB
	for <lists+linux-cifs@lfdr.de>; Mon,  1 Dec 2025 22:58:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 943012BE029;
	Mon,  1 Dec 2025 22:57:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="OJY388FS"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 544FE298CAF
	for <linux-cifs@vger.kernel.org>; Mon,  1 Dec 2025 22:57:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764629879; cv=none; b=Yi8ufGfIFlATw7dNjX2mi/iVtMfq7t2xFwJWMUu9ikuoZ8+GBVqw2OoL5ebtbpuaFQm/kc/8fpq3BKox/K183v76bXoFMjxTvb4IMixVGU9AtdflcAvP38t5V+jwwen/vKLrLP2jrIP62Bx0O0gLss7kS2CAqcoXS24rlaEl0PU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764629879; c=relaxed/simple;
	bh=gxIn+nuTbIc6+LJf/YgGHDidY2D6bLg5msCXwY/+eQY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=GH2ajDZaKiChLLtrIrTpemjCWXLXShGA8/kr9EYOkMkRbZ3MtN5NsApNWsAl6ujk6hkNOhx7ULykFbm1ZD+mztF/rtFeOze93g/xhCecer+yteFdYVZAPdeO7t3j1bs51cSpwVCTvjWfyEDGBCh1kmIJ6JRm4TWKIIvNwe/P9oM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=OJY388FS; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1764629869;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=eFai0thyF4uwfdjCkhvCcHVS3Y25wLrVUd6WgDN3AAw=;
	b=OJY388FSIAkDVTinDAvtKlg8zWvjiGlgOpTPROEUjMopbqG10F+2Mv5ccToFjasKBdP/Fl
	iIJaoObvZJsBj8nbjWvrFyuT8GHHvpsIGdhw5l/VKKbx3pkwJmqgIBqAwSQm2YfBFEtAx4
	5lSZX3BqFKXbC3YW4bIP3v//4USnXeg=
Received: from mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-214-olT1TKfSMy66_nU85fwyeQ-1; Mon,
 01 Dec 2025 17:57:45 -0500
X-MC-Unique: olT1TKfSMy66_nU85fwyeQ-1
X-Mimecast-MFC-AGG-ID: olT1TKfSMy66_nU85fwyeQ_1764629864
Received: from mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.12])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id A93181800343;
	Mon,  1 Dec 2025 22:57:43 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 4602C19560A7;
	Mon,  1 Dec 2025 22:57:39 +0000 (UTC)
...
Subject: [PATCH v6 1/9] cifs: Remove the RFC1002 header from smb_hdr
Date: Mon,  1 Dec 2025 22:57:22 +0000
Message-ID: <20251201225732.1520128-2-dhowells@redhat.com>
...
index 7fdcaf9feb16..881d3a88d683 100644
...
index 0c76e0a31386..1255e43a4d82 100644
...
index 3528c365a452..7fb40684a584 100644
...
index 428e582e0414..645831708e1b 100644
...
+	rc = SendReceive(xid, tcon->ses, (struct smb_hdr *)req, in_len,
 	...
 	cifs_stats_inc(&tcon->stats.cifs_stats.num_opens);
 	if (rc) {
@@ -1303,7 +1324,7 @@ cifs_readv_callback(struct mid_q_entry *mid)
...
+	unsigned int in_len;
 	...
 	if (tcon->ses->capabilities & CAP_LARGE_FILES) {
 		wct = 14;
@@ -1808,51 +1833,49 @@ cifs_async_writev(struct cifs_io_subrequest *wdata)
 		}
 	}
...
@@ -1862,7 +1885,7 @@ cifs_async_writev(struct cifs_io_subrequest *wdata)
 		cifs_stats_inc(&tcon->stats.cifs_stats.num_writes);
...
index 4c4f5befb6d3..d12578b37179 100644
...
+	delete_mid(mid);
 	...
 	return rc;
@@ -385,8 +351,8 @@ SendReceive(const unsigned int xid, struct cifs_ses *ses,
...
index ab42235b2955..d10fe1b11377 100644
...
index 340c44dc7b5b..a026dfd68d37 100644
...
index a15ebd3f0d50..bb5b0438a300 100644
...
@@ -397,7 +397,7 @@ cifs_check_trans2(struct mid_q_entry *mid, struct TCP_Server_Info *server,
 	mid->multiRsp = true;
 	if (mid->resp_buf) {
...
index 7ace6d4d305b..3b8d3852009e 100644
...
index 5241daaae543..441df217c796 100644
...
index 915cedde5d66..0401d3eb9370 100644
...
@@ -1086,7 +1085,7 @@ compound_send_recv(const unsigned int xid, struct cifs_ses *ses,
 	 */
 	for (i = 0; i < num_rqst; i++) {
 		if (!cancelled_mid[i])
-			delete_mid(midQ[i]);
