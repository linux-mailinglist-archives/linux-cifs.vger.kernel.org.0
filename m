...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 620CF4CE808
	for <lists+linux-cifs@lfdr.de>; Sun,  6 Mar 2022 02:11:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230025AbiCFBLy (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Sat, 5 Mar 2022 20:11:54 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37838 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232200AbiCFBLy (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Sat, 5 Mar 2022 20:11:54 -0500
Received: from mail-pj1-f49.google.com (mail-pj1-f49.google.com [209.85.216.49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0AF7835DDB;
        Sat,  5 Mar 2022 17:11:03 -0800 (PST)
Received: by mail-pj1-f49.google.com with SMTP id b8so10299491pjb.4;
        Sat, 05 Mar 2022 17:11:03 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=z5VAtpWyJhIa1cE2gPZTnGlgjaKGfrsIbKG71K6xJ2E=;
        b=
X-Gm-Message-State: AOAM532/h4vV85jKn2qYuW0o+l7nAZ79qOkiZx7ncUQAHcF/cfPjUylY
        rqZw/cVmNoWQmJ+jG3IXvNv4y+v8Btg=
X-Google-Smtp-Source: ABdhPJxzac8DowXP2s8zXp/f7dDK680uQHgTgZSUUchWb5c8fPNu5A/B768Uwf/+s9QDYRhdacicPg==
X-Received: by 2002:a17:90b:3ec7:b0:1bf:457e:c281 with SMTP id rm7-20020a17090b3ec700b001bf457ec281mr3578717pjb.145.1646529061833;
        Sat, 05 Mar 2022 17:11:01 -0800 (PST)
Received: from localhost.localdomain ([61.74.27.164])
        by smtp.gmail.com with ESMTPSA id d2-20020a056a0024c200b004f6b6817549sm7668110pfv.173.2022.03.05.17.10.59
...
Subject: [PATCH v4 3/4] ksmbd: fix racy issue from using ->d_parent and ->d_name
Date:   Sun,  6 Mar 2022 10:10:44 +0900
Message-Id: <20220306011045.13014-3-linkinjeon@kernel.org>
...
ksmbd_vfs_unlink() and use take_dentry_name_snapshot() to verify
...
---
 ...
 v3:
   ...
   - change to struct path *root argument from two argument of dentry
     and mnt.
   - check if old and new file are on same filesystem.
   - add retry_estale() check and retry.
 v2:
...
index 3151ab7d7410..bcb98109bac9 100644
...
-
 	if (!(fp->daccess & FILE_DELETE_LE)) {
 		...
 		return -EACCES;
@@ -5746,30 +5686,7 @@ static int set_rename_info(struct ksmbd_work *work, struct ksmbd_file *fp,
...
index 487617f729ec..f703dbfe22c0 100644
--- a/fs/ksmbd/vfs.c
+++ b/fs/ksmbd/vfs.c
@@ -35,19 +35,6 @@
...
+	release_dentry_name_snapshot(&name);
 	if (IS_ERR(dentry)) {
 		ret = PTR_ERR(dentry);
 		goto out_err;
@@ -689,149 +679,128 @@ int ksmbd_vfs_link(struct ksmbd_work *work, const char *oldname,
 	return err;
 }
...
@@ -1080,14 +1049,16 @@ int ksmbd_vfs_remove_xattr(struct user_namespace *user_ns,
...
@@ -1099,6 +1070,8 @@ int ksmbd_vfs_unlink(struct user_namespace *user_ns,
...
index 0974d2e972b9..ffb534281836 100644
...
index 3f1829b3ab5b..e7d3832e9b5e 100644
--- a/fs/namei.c
+++ b/fs/namei.c
...
+
 ...
 {
@@ -2623,6 +2633,24 @@ int kern_path(const char *name, unsigned int flags, struct path *path)
 }
