...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 66938402155
	for <lists+linux-cifs@lfdr.de>; Tue,  7 Sep 2021 00:47:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230169AbhIFWsN (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Mon, 6 Sep 2021 18:48:13 -0400
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124]:31744 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S229949AbhIFWsM (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Mon, 6 Sep 2021 18:48:12 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1630968425;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mZvrrtjad4o1SFlwRWrJrPJUWWGr8BhCNKCGvEF9crk=;
        b=B6JZeGOIA4kf+rKsSKZbGaZnpdE+lBz4AuVUvfGeKtI0cFK74OkxCY3bkYdUoDSxj85vR5
        vZwFy4AfyaJsk/ZBxRbpcVuC77JIr2ioQp84gpN7R3ND3poTATMt6XlIKzVXchoiiB5GJX
        QriTcXl5zf+CsfzRneRlhV2MXSXSLeE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-581-ar2MIz8gPw2oFNsJijEy9Q-1; Mon, 06 Sep 2021 18:47:04 -0400
X-MC-Unique: ar2MIz8gPw2oFNsJijEy9Q-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 16938802B9E;
        Mon,  6 Sep 2021 22:47:03 +0000 (UTC)
Received: from localhost.localdomain (vpn2-54-114.bne.redhat.com [10.64.54.114])
        by smtp.corp.redhat.com (Postfix) with ESMTP id DEAB626FD7;
        Mon,  6 Sep 2021 22:47:00 +0000 (UTC)
From:   Ronnie Sahlberg <lsahlber@redhat.com>
To:     linux-cifs <linux-cifs@vger.kernel.org>
Cc:     Steve French <smfrench@gmail.com>
Subject: [PATCH 1/4] cifs: Create a new shared file holding smb2 pdu definitions
Date:   Tue,  7 Sep 2021 08:46:45 +1000
Message-Id: <20210906224648.2062040-2-lsahlber@redhat.com>
...
index 181514b8770d..6244f0f9a380 100644
...
index 668f77108831..69250e095286 100644
...
index ddc0e8f97872..3806c60b2552 100644
--- a/fs/cifs/smb2ops.c
+++ b/fs/cifs/smb2ops.c
...
@@ -2483,13 +2483,13 @@ smb2_is_status_pending(char *buf, struct TCP_Server_Info *server)
 static bool
...
+	struct smb2_hdr *shdr = (struct smb2_hdr *)buf;
 	...
 	struct cifs_ses *ses;
 	struct cifs_tcon *tcon;
@@ -2524,7 +2524,7 @@ smb2_is_network_name_deleted(char *buf, struct TCP_Server_Info *server)
...
index b6d2e3591927..565ab538a1f0 100644
--- a/fs/cifs/smb2pdu.c
+++ b/fs/cifs/smb2pdu.c
@@ -24,7 +24,6 @@
...
+	shdr->Id.SyncId.ProcessId = cpu_to_le32((__u16)current->tgid);
 	...
 	if (!tcon)
 		goto out;
@@ -116,7 +115,7 @@ smb2_hdr_assemble(struct smb2_sync_hdr *shdr, __le16 smb2_cmd,
...
@@ -3966,7 +3965,7 @@ smb2_new_read_req(void **buf, unsigned int *total_len,
 			 * in chain.
 			 */
...
index 6f7952ea4941..eb74f4c14a93 100644
...
-#include "smb2pdu.h"
 ...
 #include "cifsproto.h"
 #include "smb2proto.h"
@@ -214,7 +213,7 @@ smb2_calc_signature(struct smb_rqst *rqst, struct TCP_Server_Info *server,
...
@@ -535,7 +534,7 @@ smb3_calc_signature(struct smb_rqst *rqst, struct TCP_Server_Info *server,
...
@@ -733,14 +732,14 @@ smb2_mid_entry_alloc(const struct smb2_sync_hdr *shdr,
...
index 000000000000..07a295d800cb
--- /dev/null
