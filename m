Return-Path: <linux-cifs+bounces-8057-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 74FB9C96778
	for <lists+linux-cifs@lfdr.de>; Mon, 01 Dec 2025 10:51:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 410CC3410B7
	for <lists+linux-cifs@lfdr.de>; Mon,  1 Dec 2025 09:50:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2E31F30215C;
	Mon,  1 Dec 2025 09:49:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="E6LrL9j8"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7CDE13019DA
	for <linux-cifs@vger.kernel.org>; Mon,  1 Dec 2025 09:49:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764582582; cv=none; b=LWuGUSjmqQneVWOy2CVu4FFvtOjjq+AQ71HksWj2z3NaUl7x28u7EISEbeqAxaI+VNVCpqsJlyUC1BJ07jQxdPB5YL2jLozIQWYA9I6u2hxKX+N1XG23Rhx4Ywgdqhl4kKZr9ok53yx5dtTahM7s69h/BV08nKVFk/cdNtwGXfo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764582582; c=relaxed/simple;
	bh=NYpI1qm63cYd5c6jGxHgd1ByL60vXtWL0/p8+oFrAxQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=bDE/GOesqOziwzsPG0aqNGxC8GJD4NgSKLezZAcBmSz3WKo8DMjX0fM+VpK97M3VF3KS2fHbpeXpNoTWygI6a9fDYaTW/m2Zzl1LWCkP5FMb41wr5fnyer6FvgPMejOoPO9hiZyfW8ydFGnCG2sN+drLsiZMAYm6kq/rcGkadbA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=E6LrL9j8; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1764582574;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=gXZSPehIvXVWMFGzgf98NaNlPGxHWAj4U3vhyLEjq6o=;
	b=E6LrL9j8BNtbRUPDzUXVJWIp0CR8pV13c0xnZuvmTQGE9rAEhL4KNZxY136FNdYemK5qVg
	e7FVb9iWPA4NBBaJDWosjvNKw8vjxdoDRRJ96nmYaUGwOOHzsVWPv0EwDOrIw6ZS4Be/OX
	9jl0XgEnmeiLTV8zdeC6Twp0umCREZ4=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-106-nH3A00KlPs2Kdx-pynd9Hg-1; Mon,
 01 Dec 2025 04:49:30 -0500
X-MC-Unique: nH3A00KlPs2Kdx-pynd9Hg-1
X-Mimecast-MFC-AGG-ID: nH3A00KlPs2Kdx-pynd9Hg_1764582567
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id ADF561800561;
	Mon,  1 Dec 2025 09:49:27 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id EE5AF3002D0B;
	Mon,  1 Dec 2025 09:49:23 +0000 (UTC)
...
Subject: [PATCH v5 1/9] cifs: Rename mid_q_entry to smb_message
Date: Mon,  1 Dec 2025 09:49:05 +0000
Message-ID: <20251201094916.1418415-2-dhowells@redhat.com>
...
@@ -117,15 +117,14 @@ extern int SendReceive(const unsigned int /* xid */ , struct cifs_ses *,
...
@@ -135,13 +134,13 @@ extern int cifs_wait_mtu_credits(struct TCP_Server_Info *server,
...
@@ -187,7 +186,7 @@ extern int decode_negTokenInit(unsigned char *security_blob, int length,
...
@@ -270,7 +269,7 @@ extern unsigned int setup_special_mode_ACE(struct smb_ace *pace,
 					   __u64 nmode);
...
@@ -777,9 +776,9 @@ static inline bool dfs_src_pathname_equal(const char *s1, const char *s2)
 	return true;
 }
