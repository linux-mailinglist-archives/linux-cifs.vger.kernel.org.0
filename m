Return-Path: <linux-cifs+bounces-177-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1630A7F9106
	for <lists+linux-cifs@lfdr.de>; Sun, 26 Nov 2023 03:55:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 624C8B20DA3
	for <lists+linux-cifs@lfdr.de>; Sun, 26 Nov 2023 02:55:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 862451110;
	Sun, 26 Nov 2023 02:55:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=manguebit.com header.i=@manguebit.com header.b="QW4mRGda"
X-Original-To: linux-cifs@vger.kernel.org
Received: from mx.manguebit.com (mx.manguebit.com [IPv6:2a01:4f8:1c1e:a2ae::2])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 34298AF
	for <linux-cifs@vger.kernel.org>; Sat, 25 Nov 2023 18:55:35 -0800 (PST)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=manguebit.com;
	...
	bh=tKqNXuGiyeajaiugGqfXH4rI14ZCdxdV3OvcbwfI4Ec=;
	b=
ARC-Seal: i=1; s=dkim; d=manguebit.com; t=1700967333; a=rsa-sha256;
	cv=none;
	b=
ARC-Authentication-Results: i=1;
	ORIGINATING;
	auth=pass smtp.auth=pc@manguebit.com smtp.mailfrom=pc@manguebit.com
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=manguebit.com;
	s=dkim; t=1700967333; h=from:from:sender:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:cc:mime-version:mime-version:
	 content-type:content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=tKqNXuGiyeajaiugGqfXH4rI14ZCdxdV3OvcbwfI4Ec=;
	b=
To: smfrench@gmail.com
Cc: linux-cifs@vger.kernel.org,
	Paulo Alcantara <pc@manguebit.com>,
	kernel test robot <lkp@intel.com>
Subject: [PATCH v2 2/9] smb: client: allow creating special files via reparse points
Date: Sat, 25 Nov 2023 23:55:03 -0300
Message-ID: <20231126025510.28147-3-pc@manguebit.com>
...
index 47f49be69ced..72431cd9530c 100644
...
@@ -1288,18 +1295,19 @@ int cifs_get_inode_info(struct inode **inode,
 	return rc;
 }
