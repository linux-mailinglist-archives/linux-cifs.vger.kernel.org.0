Return-Path: <linux-cifs+bounces-8059-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E9BFC96781
	for <lists+linux-cifs@lfdr.de>; Mon, 01 Dec 2025 10:51:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 611774E2449
	for <lists+linux-cifs@lfdr.de>; Mon,  1 Dec 2025 09:51:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 72693302CB8;
	Mon,  1 Dec 2025 09:49:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="fGGwPYxk"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AEE10302149
	for <linux-cifs@vger.kernel.org>; Mon,  1 Dec 2025 09:49:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764582587; cv=none; b=NM6Cw06qMVjxXbtwrgSHyqXGq+Rg/OynEsEU2uUBCVoV3mSYBGsj0V5Esf4Pp2G24jFMcp9+y/YxtHLAOuwfvkRedsKza0bUG7ztdNmXnloa9ERdKYzVqmzvvdBq8a54Y5p0rzH9C+ijbVbpN9bLp3bvbEnGY4ebI8vGzJ+5VhA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764582587; c=relaxed/simple;
	bh=p1JHDjUAfJXmlBMvUl1pfbqmNBoZEjnx0gC+puG5Ju8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=W4/y9REtUEO+mOgaa5X4vRHhj33qqMF/WQwiDTd3rmjOm1MpivYPOVx+D4bnkUa6Yb6yh4tx+itMwcVcYOm2v7N/kaCzzUlqfktuemU2fwtRyFFJHxuQIoGP8oUv/pffsA+0ErT/ZgyIHXrnHYl+PSnLTbk3HkAKS9TYuNKEh70=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=fGGwPYxk; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1764582578;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=nlTE+oPks7prXSg0jDwrjRaGZzNkVS0Nk8A3iLwGuew=;
	b=fGGwPYxkJbyf16udA6n2Sxech48iM3AxfLdRCWC6BX50w5Z7SyNkQCPdCZvKgYo2n19e7o
	qb1Q4+dvaYlwrKxxO9aY3cb/dZ9O4qyqNJyKbhzBHmXjaRnQv1B8re7SYoHEA7kjhUn0Ad
	DmJ80FZDPAKhMFUieGNguiVzUInNEBQ=
Received: from mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-540-beN-f6AsOJKE94s9-1G3wg-1; Mon,
 01 Dec 2025 04:49:34 -0500
X-MC-Unique: beN-f6AsOJKE94s9-1G3wg-1
X-Mimecast-MFC-AGG-ID: beN-f6AsOJKE94s9-1G3wg_1764582572
Received: from mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.17])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 74CAC1956096;
	Mon,  1 Dec 2025 09:49:32 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 2D3B61956095;
	Mon,  1 Dec 2025 09:49:28 +0000 (UTC)
...
Subject: [PATCH v5 2/9] cifs: Remove the RFC1002 header from smb_hdr
Date: Mon,  1 Dec 2025 09:49:06 +0000
Message-ID: <20251201094916.1418415-3-dhowells@redhat.com>
...
---
 ...
 18 files changed, 549 insertions(+), 528 deletions(-)
...
index 6e5c213e7b1e..1ed3dd48c4a4 100644
...
@@ -1701,6 +1701,7 @@ struct smb_message {
...
index 7e0b5fc99847..7d03b425c6bb 100644
...
@@ -145,11 +144,9 @@ extern int SendReceive2(const unsigned int /* xid */ , struct cifs_ses *,
...
+			    struct smb_hdr *out_buf, int *pbytes_returned);
 ...
 void
@@ -160,7 +157,8 @@ cifs_mark_tcp_ses_conns_for_reconnect(struct TCP_Server_Info *server,
...
@@ -187,9 +185,9 @@ extern int cifs_convert_address(struct sockaddr *dst, const char *src, int len);
...
+			     /* length of fixed section word count in two byte units  */);
 extern int small_smb_init_no_tc(const int smb_cmd, const int wct,
 				struct cifs_ses *ses,
 				void **request_buf);
@@ -564,12 +562,14 @@ extern void tconInfoFree(struct cifs_tcon *tcon, enum smb3_tcon_ref_trace trace)
...
index b383046f8532..5f0b96a5d696 100644
...
index 25f321a7fabe..d329c55e6c7b 100644
...
index ed9ba137e832..41ef55813ebb 100644
