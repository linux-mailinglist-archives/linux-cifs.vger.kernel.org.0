Return-Path: <linux-cifs+bounces-7820-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A1CCC84191
	for <lists+linux-cifs@lfdr.de>; Tue, 25 Nov 2025 09:57:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D625F3A34FD
	for <lists+linux-cifs@lfdr.de>; Tue, 25 Nov 2025 08:56:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D4647246774;
	Tue, 25 Nov 2025 08:56:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (3072-bit key) header.d=samba.org header.i=@samba.org header.b="b4Is7cVW"
X-Original-To: linux-cifs@vger.kernel.org
Received: from hr2.samba.org (hr2.samba.org [144.76.82.148])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AC79E2D8390
	for <linux-cifs@vger.kernel.org>; Tue, 25 Nov 2025 08:56:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=144.76.82.148
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764060984; cv=none; b=Qya4N0NiK//U1yErzV9zdtMBZuyl3o1+dX9NrcC9J0bC7sr+ej+leNeWA/HwTV/1e2nEPNobzkgGiFenaNbkywNSA/V990Z1zQE/gr70wpCHhMPcXLGKOQqX634Ehb83i8QK/bQSFUaAIuxwtETkLqMJTvyT5ZApXpd2B809WqM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764060984; c=relaxed/simple;
	bh=uIKXa+pcmbcXdjSrZ2v1NXxx0jrLMoL7jnFsu6xaXcY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=BJtWyV50Af4ZADrjHVa1lyRpskCjRe41KfitwrFS3v1C3c7ncFqGNRRNNNJX9Xh3CsoaOL5YgbAOmdxX4dqrrssNCceVHHi9swvOFBRzUSXUt7K5kUU4axRcFHrrzfJLvS9ioUZAO/zVAKO1Jm1Q6FW9lczFocGyTyNmkaU70Gc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=samba.org; spf=pass smtp.mailfrom=samba.org; dkim=pass (3072-bit key) header.d=samba.org header.i=@samba.org header.b=b4Is7cVW; arc=none smtp.client-ip=144.76.82.148
...
Subject: [PATCH v2 3/4] smb: server: relax WARN_ON_ONCE(SMBDIRECT_SOCKET_*) checks in recv_done() and smb_direct_cm_handler()
