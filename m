...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 217A757E7A4
	for <lists+linux-cifs@lfdr.de>; Fri, 22 Jul 2022 21:48:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229522AbiGVTsl (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Fri, 22 Jul 2022 15:48:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47916 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232476AbiGVTsk (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Fri, 22 Jul 2022 15:48:40 -0400
Received: from mail-ua1-x936.google.com (mail-ua1-x936.google.com [IPv6:2607:f8b0:4864:20::936])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4AC2A7D7A7
        for <linux-cifs@vger.kernel.org>; Fri, 22 Jul 2022 12:48:37 -0700 (PDT)
Received: by mail-ua1-x936.google.com with SMTP id y12so1204637uad.10
        for <linux-cifs@vger.kernel.org>; Fri, 22 Jul 2022 12:48:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=ET4UmAcp6WB5oz1134F9r6a8LidXKGszKEZMk77+eqE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ET4UmAcp6WB5oz1134F9r6a8LidXKGszKEZMk77+eqE=;
        b=
X-Gm-Message-State: AJIora8bnXOtBfxu5qvDcQPpuPhkabBbJe9NvkOjXCO3NfwZmP501tPU
        AVQQQR/V5RZZPrV25w+2ExCQfq5x2qFvKWMWCr+nK47GLp+G0A==
X-Google-Smtp-Source: AGRyM1vsnjqymQlEdWJxEoK6PCfxyIA7xO3mR3IPhpiprNzfYVCfXnaPlwiMXcjEHTR/Atu+vGJo0Ufofca6MUGtc68=
X-Received: by 2002:ab0:3f0c:0:b0:383:f357:9c02 with SMTP id
 bt12-20020ab03f0c000000b00383f3579c02mr652746uab.19.1658519315779; Fri, 22
 Jul 2022 12:48:35 -0700 (PDT)
MIME-Version: 1.0
References: <20220722191003.7223-1-ematsumiya@suse.de>
In-Reply-To: <20220722191003.7223-1-ematsumiya@suse.de>
From:   Steve French <smfrench@gmail.com>
Date:   Fri, 22 Jul 2022 14:48:24 -0500
Message-ID: <CAH2r5mvvmM0fesOSRiksS2KzaPTcj2k1ESXC0YBgXJtjD2Cpeg@mail.gmail.com>
Subject: Re: [PATCH] cifs: remove dead/commented code, cifsproto.h cleanup
...
I prefer that comments that help make the array contents clearer e.g.

diff --git a/fs/cifs/cifs_ioctl.h b/fs/cifs/cifs_ioctl.h
index b87cbbe6d2d4..03e6531998b0 100644
--- a/fs/cifs/cifs_ioctl.h
+++ b/fs/cifs/cifs_ioctl.h
@@ -30,7 +30,6 @@ struct smb_snapshot_array {
...
-       /*      snapshots[]; */
 ...
 /* query_info flags */
@@ -44,7 +43,6 @@ struct smb_query_info {
        __u32   flags;
...
are ok to leave in.  Although if needed can change it so it is more
obvious.   We also could change the smb_query_info example to have
"char buffer[];" uncommented since it is zero length so won't change
the size and might make it clearer.
...
On Fri, Jul 22, 2022 at 2:10 PM Enzo Matsumiya <ematsumiya@suse.de> wrote:
>
...
>  14 files changed, 354 insertions(+), 636 deletions(-)
>
