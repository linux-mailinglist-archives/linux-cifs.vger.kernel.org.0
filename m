Return-Path: <linux-cifs+bounces-7756-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id A4254C7E9FA
	for <lists+linux-cifs@lfdr.de>; Mon, 24 Nov 2025 00:53:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id D2CC2343CE7
	for <lists+linux-cifs@lfdr.de>; Sun, 23 Nov 2025 23:53:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EF8D9275AFB;
	Sun, 23 Nov 2025 23:53:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="EdNRCgzM"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8B82C27A465
	for <linux-cifs@vger.kernel.org>; Sun, 23 Nov 2025 23:53:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763941993; cv=none; b=V5sO/o+6+FgiUTQdK9l8/9ucDMzrx40gj5YXr7dEFKaHLBKP8cV8RFeM11ZD5WNBEQBag926BjCABvc0D9B/zaQ2FQ4sL6vc+3w8RYjYMxcvtLTJKnDo8gHlCrT9AZ21Mw0hjUBP7pVtkrO0uZnFACdNLNjjhChEPfQ/mdATjj4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763941993; c=relaxed/simple;
	bh=JgjLRiM/LHXIKnyntc2YB/viPvDQ5g/9fhlKBQ4361A=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=DEALO0jLten29B78erTBS9EuAjq+W9c5p5+xkbISchRGfPD5zpV35XWzhynf3qGGQSRnjYKU+IaJ21MNsK/AZeeF/f3Y8lN4C/XKqKDnIPlX2GXctdFpJB/evttAXQQlNPXi6nob1eK+3wt3n+qlRcrPS5CWPq+u56/2nz/uN8E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=EdNRCgzM; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1763941983;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=B+Nj7zevlFV44jxEkQi/vrJgToZC4S7tj+UPwxNYLTw=;
	b=EdNRCgzMs9Fdq7kGWgfH8yMQ+oM7CBV7fk4IheYccN9Vf3uoaMDtti3ehjt+y5HDCKr8O0
	xwBe3i/Zt75N11Hhh71nNfFDa3elXpha96LaUBzmb5RMhpmwzfMyp5d0jMw3Fz9OHA2K5V
	06RvFBDojzUuT8StpfwsUnjx53XQA+I=
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-60-uAvFdRZGMTu2jqSoBBsDBQ-1; Sun,
 23 Nov 2025 18:52:58 -0500
X-MC-Unique: uAvFdRZGMTu2jqSoBBsDBQ-1
X-Mimecast-MFC-AGG-ID: uAvFdRZGMTu2jqSoBBsDBQ_1763941976
Received: from mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.93])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 822B01956094;
	Sun, 23 Nov 2025 23:52:56 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 3B4611800451;
	Sun, 23 Nov 2025 23:52:53 +0000 (UTC)
...
Subject: [PATCH v3 02/12] cifs: Clean up declarations
Date: Sun, 23 Nov 2025 23:52:29 +0000
Message-ID: <20251123235242.3361706-3-dhowells@redhat.com>
...
---
 ...
 fs/smb/client/cifsproto.h    | 1213 ++++++++++++++++------------------
 ...
 22 files changed, 1092 insertions(+), 1119 deletions(-)
...
index 7ec2623cf2a0..e2e59b6d5415 100644
--- a/fs/smb/client/cifsproto.h
+++ b/fs/smb/client/cifsproto.h
@@ -18,20 +18,585 @@ struct statfs;
 struct smb_rqst;
 struct smb3_fs_context;
...
-						    void *page, bool prefix);
 ...
 {
 	return __getname();
@@ -73,61 +628,6 @@ static inline void free_dentry_path(void *page)
 		__putname(page);
 }
...
-
 ...
 send_cancel(struct TCP_Server_Info *server, struct smb_rqst *rqst,
 	    struct mid_q_entry *mid)
@@ -136,299 +636,6 @@ send_cancel(struct TCP_Server_Info *server, struct smb_rqst *rqst,
...
-
 struct cifs_unix_set_info_args {
 	__u64	ctime;
 	__u64	atime;
@@ -439,260 +646,8 @@ struct cifs_unix_set_info_args {
 	dev_t	device;
 };
...
@@ -704,14 +659,6 @@ static inline int get_dfs_path(const unsigned int xid, struct cifs_ses *ses,
 			      referral, NULL);
 }
...
-				   bool *islink);
 ...
 static inline int cifs_inval_name_dfs_link_error(const unsigned int xid,
 				   struct cifs_tcon *tcon,
@@ -732,8 +679,6 @@ static inline int cifs_create_options(struct cifs_sb_info *cifs_sb, int options)
 		return options;
 }
