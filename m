...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B34363BB57C
	for <lists+linux-cifs@lfdr.de>; Mon,  5 Jul 2021 05:18:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230020AbhGEDU2 (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Sun, 4 Jul 2021 23:20:28 -0400
Received: from mailout4.samsung.com ([203.254.224.34]:61600 "EHLO
        mailout4.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229907AbhGEDUM (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Sun, 4 Jul 2021 23:20:12 -0400
Received: from epcas1p3.samsung.com (unknown [182.195.41.47])
        by mailout4.samsung.com (KnoxPortal) with ESMTP id 20210705031734epoutp04c91007991521c752dce97df6b59aeea3~OxsKFgOwc0937709377epoutp04C
        for <linux-cifs@vger.kernel.org>; Mon,  5 Jul 2021 03:17:34 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout4.samsung.com 20210705031734epoutp04c91007991521c752dce97df6b59aeea3~OxsKFgOwc0937709377epoutp04C
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1625455054;
        bh=PElli4dc2ux5cErW7WBfv6sqbu0hs4m9ZuA7fmNhfY4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=lmxxl02+tanMIq+gHkDvbLddmqUALCuF30x+O2CSogPa/B+EbyDzmIFMYIJpWLaf1
         p6jdlzLNKhwE3Ttx+c8gdidjfHL0XFqVWXGdefuwAKjOSi92EoTdcEMrMqa7OUhlAQ
         QAXY6VWy7XllxEmfRpsZkRI2Tug6qvHTs0ZeKEvM=
Received: from epsnrtp1.localdomain (unknown [182.195.42.162]) by
        epcas1p1.samsung.com (KnoxPortal) with ESMTP id
        20210705031733epcas1p14c58c68eb0a1b8d0ea55ac6ddfd7cca5~OxsJdsDoN1197211972epcas1p1_;
        Mon,  5 Jul 2021 03:17:33 +0000 (GMT)
Received: from epsmges1p2.samsung.com (unknown [182.195.40.166]) by
        epsnrtp1.localdomain (Postfix) with ESMTP id 4GJ9q03mCCz4x9Q2; Mon,  5 Jul
        2021 03:17:32 +0000 (GMT)
Received: from epcas1p3.samsung.com ( [182.195.41.47]) by
        epsmges1p2.samsung.com (Symantec Messaging Gateway) with SMTP id
        E9.9F.09551.CC972E06; Mon,  5 Jul 2021 12:17:32 +0900 (KST)
Received: from epsmtrp1.samsung.com (unknown [182.195.40.13]) by
        epcas1p2.samsung.com (KnoxPortal) with ESMTPA id
        20210705031732epcas1p204889c896c550f2e23b31207c406eca6~OxsH91xf91374013740epcas1p2e;
        Mon,  5 Jul 2021 03:17:32 +0000 (GMT)
Received: from epsmgms1p2.samsung.com (unknown [182.195.42.42]) by
        epsmtrp1.samsung.com (KnoxPortal) with ESMTP id
        20210705031732epsmtrp155b2af90c05d3483aa3a3f800f82ab02~OxsH87wsU0836508365epsmtrp1A;
        Mon,  5 Jul 2021 03:17:32 +0000 (GMT)
X-AuditID: b6c32a36-2b3ff7000000254f-92-60e279cce4a4
Received: from epsmtip2.samsung.com ( [182.195.34.31]) by
        epsmgms1p2.samsung.com (Symantec Messaging Gateway) with SMTP id
        A8.EC.08289.BC972E06; Mon,  5 Jul 2021 12:17:31 +0900 (KST)
Received: from localhost.localdomain (unknown [10.89.31.111]) by
        epsmtip2.samsung.com (KnoxPortal) with ESMTPA id
        20210705031731epsmtip2aa8188025fb79983149e2ca88df5c056~OxsHpl9qz2672126721epsmtip2S;
        Mon,  5 Jul 2021 03:17:31 +0000 (GMT)
...
Subject: [PATCH v5 10/13] ksmbd: add oplock/lease cache mechanism
Date:   Mon,  5 Jul 2021 12:07:26 +0900
Message-Id: <20210705030729.10292-11-namjae.jeon@samsung.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210705030729.10292-1-namjae.jeon@samsung.com>
X-Brightmail-Tracker: 
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFvrGLMWRmVeSWpSXmKPExsWy7bCSvO7pykcJBjunm1s0vj3NYnH89V92
        ...
        
X-CMS-MailID: 20210705031732epcas1p204889c896c550f2e23b31207c406eca6
X-Msg-Generator: CA
...
X-CMS-RootMailID: 20210705031732epcas1p204889c896c550f2e23b31207c406eca6
References: <20210705030729.10292-1-namjae.jeon@samsung.com>
        <CGME20210705031732epcas1p204889c896c550f2e23b31207c406eca6@epcas1p2.samsung.com>
Precedence: bulk
...
index 000000000000..71063568dfee
--- /dev/null
+++ b/fs/ksmbd/oplock.c
@@ -0,0 +1,1708 @@
