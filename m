Return-Path: <linux-cifs+bounces-9414-lists+linux-cifs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-cifs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id oMjLG4/alGlyIQIAu9opvQ
	(envelope-from <linux-cifs+bounces-9414-lists+linux-cifs=lfdr.de@vger.kernel.org>)
	for <lists+linux-cifs@lfdr.de>; Tue, 17 Feb 2026 22:15:59 +0100
X-Original-To: lists+linux-cifs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F1CE150A3B
	for <lists+linux-cifs@lfdr.de>; Tue, 17 Feb 2026 22:15:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 240C230484DC
	for <lists+linux-cifs@lfdr.de>; Tue, 17 Feb 2026 21:14:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8ABE437AA8E;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[patchwork-bot@kernel.org,linux-cifs@vger.kernel.org];
	RCVD_TLS_LAST(0.00)[];
	DKIM_TRACE(0.00)[kernel.org:+];
	TAGGED_FROM(0.00)[bounces-9414-lists,linux-cifs=lfdr.de,f2fs];
	MIME_TRACE(0.00)[0:+];
