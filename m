Return-Path: <linux-cifs+bounces-7758-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id E0391C7EA1C
	for <lists+linux-cifs@lfdr.de>; Mon, 24 Nov 2025 00:54:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 0B1664E33A5
	for <lists+linux-cifs@lfdr.de>; Sun, 23 Nov 2025 23:53:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3295A2820DB;
	Sun, 23 Nov 2025 23:53:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="UAyPm2rZ"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 47A2427FD6D
	for <linux-cifs@vger.kernel.org>; Sun, 23 Nov 2025 23:53:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763942000; cv=none; b=jVINk6euEICR3hnFX44VfMcifJUC+/jOhA6so2UodFbPIb3maQ5yGcznRbyHuUEzV36Sfo7t6UEYVH4Crgiq/xaHSaWpHruNidtNEI21pH77V6NokOAUDdOXkM2Tf0+PE3EcpiTOckwp6eHwg5buiTK5akWQJPxT7/utyenbeJ4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763942000; c=relaxed/simple;
	bh=Kih0WQaLV6LFFx8hXd8Su2Cj+HtRhhpZPShNbiJcSS8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=d9VaaXA1oylPqbLmXBjD6jgsA+mDd5I0FF+8oV3Jb9WxDVVbg+3BhsJxqPFRK7LNwsJT28mdvBHtIeDgD2+oLAKzDG+4shInyAlcgrnvVkUnNe4fAuwiNAdLhK9hJC//I1eaBAH56r8vJoOs7r840DB7xyTqsJahoJm0KymI3dA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=UAyPm2rZ; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1763941993;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=/In+dEed7UdGUrViW/BGXew48ShNYmPvejN4qs0QABI=;
	b=UAyPm2rZOqUUkHCA5g6XIh404U67LO89WaoVuUZcf4tHqeiHodyP2dTuiqiWBxGCrZuQuR
	oBYdjseiIjoS+FOIiSR8ZpDbiXI59mGtvkytLe2JrOYoZbXC8Qv0Q77KOi1XhAT8p73RoV
	e5KH2Y2dA9UAnLHgdsNR1Ot+Ca10jZ8=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-369-_aW-OrQ-NSOl4mseazevzQ-1; Sun,
 23 Nov 2025 18:53:09 -0500
X-MC-Unique: _aW-OrQ-NSOl4mseazevzQ-1
X-Mimecast-MFC-AGG-ID: _aW-OrQ-NSOl4mseazevzQ_1763941988
Received: from mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.12])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id D6FE5180048E;
	Sun, 23 Nov 2025 23:53:07 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 26D9A1955F6E;
...
Subject: [PATCH v3 05/12] cifs: Rename mid_q_entry to smb_message
Date: Sun, 23 Nov 2025 23:52:32 +0000
Message-ID: <20251123235242.3361706-6-dhowells@redhat.com>
...
index e2e59b6d5415..511953fa5ae4 100644
--- a/fs/smb/client/cifsproto.h
+++ b/fs/smb/client/cifsproto.h
@@ -136,9 +136,9 @@ int cifs_read_from_socket(struct TCP_Server_Info *server, char *buf,
...
@@ -462,7 +462,7 @@ struct vfsmount *cifs_d_automount(struct path *path);
...
@@ -550,9 +550,9 @@ int E_md4hash(const unsigned char *passwd, unsigned char *p16,
 /*
  * transport.c
  */
...
@@ -562,12 +562,12 @@ int wait_for_free_request(struct TCP_Server_Info *server, const int flags,
...
+int cifs_sync_mid_result(struct smb_message *mid, struct TCP_Server_Info *server);
 ...
 int compound_send_recv(const unsigned int xid, struct cifs_ses *ses,
 		       struct TCP_Server_Info *server,
@@ -578,7 +578,7 @@ int cifs_send_recv(const unsigned int xid, struct cifs_ses *ses,
...
+int cifs_readv_receive(struct TCP_Server_Info *server, struct smb_message *mid);
 ...
 /*
  * unc.c
@@ -630,10 +630,10 @@ static inline void free_dentry_path(void *page)
...
@@ -712,9 +712,9 @@ static inline bool dfs_src_pathname_equal(const char *s1, const char *s2)
 	return true;
 }
...
index 549fffbca246..c116bfb20c4d 100644
...
index 4ec61f4f90be..b4433a0bf022 100644
