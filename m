...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6FC613BB573
	for <lists+linux-cifs@lfdr.de>; Mon,  5 Jul 2021 05:17:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229980AbhGEDUW (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Sun, 4 Jul 2021 23:20:22 -0400
Received: from mailout3.samsung.com ([203.254.224.33]:21623 "EHLO
        mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229817AbhGEDUK (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Sun, 4 Jul 2021 23:20:10 -0400
Received: from epcas1p1.samsung.com (unknown [182.195.41.45])
        by mailout3.samsung.com (KnoxPortal) with ESMTP id 20210705031731epoutp03d7b89d496749c6e922fcb4e2f02ea86e~OxsHMLmxR3232632326epoutp03_
        for <linux-cifs@vger.kernel.org>; Mon,  5 Jul 2021 03:17:31 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout3.samsung.com 20210705031731epoutp03d7b89d496749c6e922fcb4e2f02ea86e~OxsHMLmxR3232632326epoutp03_
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1625455051;
        bh=g0mD+5v0L7v+Km3OZAnPI5n2fVRSgvNdXonK3ve9U/k=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=M0miTJ7YFrTMJ3FwAofoUeo83f8MNdGVnDen0M+q8TnqpK/zQfZCbtDFC0Lk7TH6g
         TZS5kUs6PFWAet5PYixRRaXP6/2UzjAUt0Ap3aVD2+//eyXkNcB+MbhNbtQGokFpU1
         o4Ta2Y/NjLjuf/jfFsIJj4CekrQHAUG5BhOiVAm8=
Received: from epsnrtp4.localdomain (unknown [182.195.42.165]) by
        epcas1p2.samsung.com (KnoxPortal) with ESMTP id
        20210705031730epcas1p2b7808bf580c3654df52a36ed3bde8489~OxsGrXffE1603716037epcas1p2J;
        Mon,  5 Jul 2021 03:17:30 +0000 (GMT)
Received: from epsmges1p3.samsung.com (unknown [182.195.40.159]) by
        epsnrtp4.localdomain (Postfix) with ESMTP id 4GJ9px4cdCz4x9Px; Mon,  5 Jul
        2021 03:17:29 +0000 (GMT)
Received: from epcas1p1.samsung.com ( [182.195.41.45]) by
        epsmges1p3.samsung.com (Symantec Messaging Gateway) with SMTP id
        5A.3C.09468.9C972E06; Mon,  5 Jul 2021 12:17:29 +0900 (KST)
Received: from epsmtrp2.samsung.com (unknown [182.195.40.14]) by
        epcas1p1.samsung.com (KnoxPortal) with ESMTPA id
        20210705031729epcas1p171c94cbdc4994a7f9f8370da1aa1ae30~OxsFU45x11195311953epcas1p1D;
        Mon,  5 Jul 2021 03:17:29 +0000 (GMT)
Received: from epsmgms1p1new.samsung.com (unknown [182.195.42.41]) by
        epsmtrp2.samsung.com (KnoxPortal) with ESMTP id
        20210705031729epsmtrp2ea0bacc3c5607aa044028f1cb5c3cc48~OxsFToMx21726817268epsmtrp2_;
        Mon,  5 Jul 2021 03:17:29 +0000 (GMT)
X-AuditID: b6c32a37-0c7ff700000024fc-12-60e279c9508e
Received: from epsmtip2.samsung.com ( [182.195.34.31]) by
        epsmgms1p1new.samsung.com (Symantec Messaging Gateway) with SMTP id
        EF.AB.08394.8C972E06; Mon,  5 Jul 2021 12:17:28 +0900 (KST)
Received: from localhost.localdomain (unknown [10.89.31.111]) by
        epsmtip2.samsung.com (KnoxPortal) with ESMTPA id
        20210705031728epsmtip237e2a509743c58e6df267cc849a30a8d~OxsE9hQNS2672126721epsmtip2P;
...
Subject: [PATCH v5 07/13] ksmbd: add authentication
Date:   Mon,  5 Jul 2021 12:07:23 +0900
Message-Id: <20210705030729.10292-8-namjae.jeon@samsung.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210705030729.10292-1-namjae.jeon@samsung.com>
X-Brightmail-Tracker: 
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFvrGLMWRmVeSWpSXmKPExsWy7bCSvO6JykcJBm+OW1s0vj3NYnH89V92
        ...
        
X-CMS-MailID: 20210705031729epcas1p171c94cbdc4994a7f9f8370da1aa1ae30
X-Msg-Generator: CA
...
X-CMS-RootMailID: 20210705031729epcas1p171c94cbdc4994a7f9f8370da1aa1ae30
References: <20210705030729.10292-1-namjae.jeon@samsung.com>
        <CGME20210705031729epcas1p171c94cbdc4994a7f9f8370da1aa1ae30@epcas1p1.samsung.com>
Precedence: bulk
