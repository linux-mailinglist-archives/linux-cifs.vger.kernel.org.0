Return-Path: <linux-cifs+bounces-7764-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D4C8C7EA41
	for <lists+linux-cifs@lfdr.de>; Mon, 24 Nov 2025 00:55:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B45513A3B67
	for <lists+linux-cifs@lfdr.de>; Sun, 23 Nov 2025 23:55:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCCD628A701;
	Sun, 23 Nov 2025 23:53:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="VSkkJPUO"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 735D12882CE
	for <linux-cifs@vger.kernel.org>; Sun, 23 Nov 2025 23:53:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763942031; cv=none; b=FjtiG3jk37GQX01zYlna7lfjfx98+YeRDAgNbf2bkk0xrklvRXGLgGfkKv+Vt9puuhnK535pGreDFa69LyICh698Imod6Zsv3X/O8gQd0qZP7LkF2nj7t3zLB8Wv8DNvqFI0dbzyR9MWIXphOMCumhKxNiMy/8w0IFyviN3t2Mo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763942031; c=relaxed/simple;
	bh=zwbyo07NtFAF3tNMnAvwMR91AUBQLli6LmrMs9nxvEc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Zig1ocA6nZZGLydAdiZYAtsBFh4DWZaaUonERwHuhSnI6Hvxc/gar7G8nCgz2UYE7oLbsgCJBofJlAIH3Ae7EuRSRtAMPfDwiSDBf5eFeWt/txDG58jYKQxUYOZLrVGk2178LMgSD4rU4wcXUzD2yW8U1GMMoUXuMVr9yuUvnUI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=VSkkJPUO; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1763942021;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=VbGKK51iUN8bd8//iT47N9fhTrERUoDsQvaD91Kx6M8=;
	b=VSkkJPUOGcBrde/DYyRI+LXfZCvRH5Ua2ghmgh3pujIAL3iCjL7CKNzS9p1uckg2IxQdxo
	MAb/g0CHxoRIIbjCNxfRUoMuZylJTktp5LQpuF46EEe9vc4Hu0rSN9ar3UwLdmPKRqSeuT
	U18bWWMX9FqjRmJvukD8BgFEA39OOgM=
Received: from mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-127-2BP9NfbUMR-WdTd5f7iExQ-1; Sun,
 23 Nov 2025 18:53:36 -0500
X-MC-Unique: 2BP9NfbUMR-WdTd5f7iExQ-1
X-Mimecast-MFC-AGG-ID: 2BP9NfbUMR-WdTd5f7iExQ_1763942015
Received: from mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.12])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 46B18180047F;
	Sun, 23 Nov 2025 23:53:35 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 9643D19560A7;
	Sun, 23 Nov 2025 23:53:32 +0000 (UTC)
...
Subject: [PATCH v3 12/12] cifs: Add a tracepoint to log EIO errors
Date: Sun, 23 Nov 2025 23:52:39 +0000
Message-ID: <20251123235242.3361706-13-dhowells@redhat.com>
...
@@ -175,7 +175,7 @@ int open_cached_dir(unsigned int xid, struct cifs_tcon *tcon,
...
index b583e97f9962..678fb84624f7 100644
--- a/fs/smb/client/cifsproto.h
+++ b/fs/smb/client/cifsproto.h
@@ -729,4 +729,110 @@ static inline void cifs_free_open_info(struct cifs_open_info_data *data)
...
index d3291d7afe1e..312866472e73 100644
...
index 95f036a9c1e8..7357d302ac80 100644
