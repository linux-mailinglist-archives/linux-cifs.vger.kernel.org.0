Return-Path: <linux-cifs+bounces-3352-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 577769C302E
	for <lists+linux-cifs@lfdr.de>; Sun, 10 Nov 2024 01:50:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id D2CA51F212A2
	for <lists+linux-cifs@lfdr.de>; Sun, 10 Nov 2024 00:50:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A3BCA33F7;
	Sun, 10 Nov 2024 00:50:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="C9SdbD8M"
X-Original-To: linux-cifs@vger.kernel.org
Received: from mail-lf1-f42.google.com (mail-lf1-f42.google.com [209.85.167.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D4AC7DDD9
	for <linux-cifs@vger.kernel.org>; Sun, 10 Nov 2024 00:50:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731199810; cv=none; b=F5l8zx0tI4vG7/Spf7uuqEfLT9HhNWV3QGZMoJBjCuz8CMzXf7C7cEtOLOs8Gp4DQPnKcDwNQ5R7j72bvBnu8nR78kY0ofKKi32m9d9+S1U3l6j92V+8Wli8hGUuYcuh4pZPVslCSkus+ftHTKN8FRM9OCBARzfmfcEy/pStVug=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731199810; c=relaxed/simple;
	bh=8T9dqaHlCfLBTSedYMYBF8hNz7nTLA/yimcA9N96IVY=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=Vy6zqTIi7Vkc0CFiY1RE+HwLVwO7NBB1QDIqGKeJGIS3D4uPf9tf5fbUCsrlE40VPKonDVl7ebfW1fpWo0EVXNpl4i4K32O4zQMfhG1i3zmQp473GqTwRNSikFGnVCUlprAFFNyjRiVxpOw7WSjsUsQ/S7f4gj1mR/JOu1h9HzA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=C9SdbD8M; arc=none smtp.client-ip=209.85.167.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-lf1-f42.google.com with SMTP id 2adb3069b0e04-53d8c44476cso660932e87.0
        for <linux-cifs@vger.kernel.org>; Sat, 09 Nov 2024 16:50:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1731199806; x=1731804606; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=BgaGix2S3gpSKPWIZIhPHe+D8RrJKz2jiii9Qzm/p1c=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1731199806; x=1731804606;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=BgaGix2S3gpSKPWIZIhPHe+D8RrJKz2jiii9Qzm/p1c=;
        b=
X-Gm-Message-State: AOJu0YxgSHo+KyFQiOTQ2fZQKE1uh4BCNUzpDvFjjWhS0MvHaCEl9LnX
	acZl1ZN5az58a6ps55uAPINAO1OLjov6VbRrbCcK9Da0Pstc/GaBRjs5ySgs0uu7EM9RihPBepN
	6CZ6X9DTondjqlTxcbJwbRrLQxmQ=
X-Google-Smtp-Source: AGHT+IGo9NElGbDf8GLa13Hpy9cDGmTcISKRpZXksaPdYgNA6gtcegJrvLRx5wD/zAPJry61QwyUHhnybpA3GrTKHoc=
X-Received: by 2002:a05:6512:2305:b0:539:e6fc:4172 with SMTP id
 2adb3069b0e04-53d8623186amr3644771e87.21.1731199805522; Sat, 09 Nov 2024
 16:50:05 -0800 (PST)
Precedence: bulk
...
In-Reply-To: <igo6lqdjrldrgv5lq344yfsxrrgfwffdrxga3uh3umr324o3zb@icma7vfguafs>
From: Steve French <smfrench@gmail.com>
Date: Sat, 9 Nov 2024 18:49:54 -0600
Message-ID: <CAH2r5muas7-EAyZa6LnaWNEtSc3MyB7TtGZrW=WgxRMUgb5e0Q@mail.gmail.com>
...
[ 2039.224416] RAX: dffffc0000000000 RBX: ff11000110ba3d80 RCX: 00000000000=
00027
[ 2039.224422] RDX: 0000000000000027 RSI: 0000000000000004 RDI: ff110004cb0=
b1a08
[ 2039.224427] RBP: ff11000112ebb8f8 R08: ffffffffa13f759e R09: ffe21c00996=
16341
3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D


On Fri, Nov 8, 2024 at 5:12=E2=80=AFPM Enzo Matsumiya <ematsumiya@suse.de> =
wrote:
>
...
> crash> cached_fid.entry,cfids,path,has_lease,is_open,on_list,time,tcon,re=
fcount 0xffff892f4b5b3e00
>    entry =3D {
...
> wrote:
> >>>
> >>>The SMB client cached directory functionality has a few problems aroun=
d
...
> >>>
> >>>Based on bisection, these issues started with the lease directory cach=
e
...
> >>>'nohandlecache'.  I started seeing these on Debian Bookworm stable ker=
nel
> >>>(v6.1.x), but the issues persist even in current git versions.  I thin=
k the
...
> >>>
> >>>
> >>>I'm able to reproduce the "Dentry still in use" errors by connecting t=
o an
> >>>actively-used SMB share (the server organically generates lease breaks=
) and
> >>>leaving these running for 'a while':
> >>>
> >>>- while true; do cd ~; sleep 1; for i in {1..3}; do cd /mnt/test/subdi=
r; echo $PWD; sleep 1; cd ..; echo $PWD; sleep 1; done; echo ...; done
> >>>- while true; do iptables -F OUTPUT; mount -t cifs -a; for _ in {0..2}=
; do ls /mnt/test/subdir/ | wc -l; done; iptables -I OUTPUT -p tcp --dport =
445 -j DROP; sleep 10; echo "unmounting"; umount -l -t cifs -a; echo "done =
unmounting"; sleep 20; echo "recovering"; iptables -F OUTPUT; sleep 10; don=
e
> >>>
> >>>('a while' is anywhere from 10 minutes to overnight. Also, it's not th=
e
> >>>cleanest reproducer, but I stopped iterating once I had something that=
 was
> >>>even remotely reliable for me...)
> >>>
> >>>This series attempts to fix these, as well as a use-after-free that co=
uld
> >>>occur because open_cached_dir() explicitly frees the cached_fid, rathe=
r than
> >>>relying on reference counting.
> >>>
> >>>
> >>>The last patch in this series (smb: During umount, flush any pending l=
ease
> >>>breaks for cached dirs) is a work-in-progress, and should not be taken=
 as-is.
> >>>The issue there:
> >>>
> >>>Unmounting an SMB share (cifs_kill_sb) can race with a queued lease br=
eak from
> >>>the server for a cached directory.  When this happens, the cfid is rem=
oved
> >>>from the linked list, so close_all_cached_dirs() cannot drop the dentr=
y.  If
> >>>cifs_kill_sb continues on before the queued work puts the dentry, we t=
rigger
> >>>the "Dentry still in use" BUG splat.  Flushing the cifsiod_wq seems to=
 help
> >>>this, but some thoughts:
> >>>
> >>>1. cifsiod_wq is a global workqueue, rather than per-mount.  Flushing =
the
> >>>   entire workqueue is potentially doing more work that necessary.  Sh=
ould
> >>>   there be a workqueue that's more appropriately scoped?
> >>>2. With an unresponsive server, this causes umount (even umount -l) to=
 hang
> >>>   (waiting for SMB2_close calls), and when I test with backports on a=
 6.1
> >>>   kernel, appears to cause a deadlock between kill_sb and some cifs
> >>>   reconnection code calling iterate_supers_type.  (Pretty sure the de=
adlock
> >>>   was addressed by changes to fs/super.c, so not really an SMB proble=
m, but
> >>>   just an indication that flush_waitqueue isn't the right solution).
> >>>3. Should cached_dir_lease_break() drop the dentry before queueing wor=
k
> >>>   (and if so, is it OK to do this under the spinlock, or should the s=
pinlock
> >>>   be dropped first)?
> >>>4. Related to #3 -- shouldn't close_all_cached_dirs() be holding the s=
pinlock
> >>>   while looping?
> >>>
> >>>
> >>>Lastly, patches 2, 3, and 5 (in its final form) are beneficial going b=
ack to
> >>>v6.1 for stable, but it's not a clean backport because some other impo=
rtant
