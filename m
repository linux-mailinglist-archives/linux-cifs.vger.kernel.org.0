Return-Path: <linux-cifs+bounces-7673-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 45527C5DAA4
	for <lists+linux-cifs@lfdr.de>; Fri, 14 Nov 2025 15:46:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 674D23A5EDB
	for <lists+linux-cifs@lfdr.de>; Fri, 14 Nov 2025 14:45:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AF77032861A;
	Fri, 14 Nov 2025 14:43:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="cs4lsrtP"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 53A1C328274
	for <linux-cifs@vger.kernel.org>; Fri, 14 Nov 2025 14:43:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763131410; cv=none; b=dz+ZWkngFLJ8lVs4Uw9wGW+fJkKiGFkcUSb/fGxK8kQlXMV8F7Fgi42JWMbbdG9S52b/M4bOf+mGLcp+d4ieKypYdWeYDrwghfYyntP9+ULTo36NfAJmg0FcltOPRz68gcONlk4ygdPsDBbylgDCxNQdpSOA4kkb1+68kDTzxmk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763131410; c=relaxed/simple;
	bh=RfxhxxhB5026syee9Q2gSXAlxInauMiEsGURvBHCouQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=bCNIvx8Rsqks+33gBHC0Qa7t/bHjQQHWT/blwJybwA2xapeb9RYyyf/qeoVNaeJYe4/FAWxsosY7iflejpa21WBsOg8NfoM9Lmpes4M+7ymHuCVB3wD9+fADT6q/NGwSTu6s0bJf3SvhUyayo2Ta8X+JTqslnoy7cKmsCsO36wQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=cs4lsrtP; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1763131407;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=XXLihDA72nJow9Bzz+a5S/zAdGzLx+8eligt7grf8UY=;
	b=cs4lsrtP6vfBBekTBTzbC6giJPXrJVy0jFJvAFTcM4PEsgoK171j5nhRfYDIq8Xi9BIE9T
	MmkViOiv4NpQ80vypXBk+ekDE+toaltbdnIN1EaHrNzsA83f5KarpgsKIspOFwrHzDyWly
	rSSVbUXvY53rmkICt2m4xJjEeM794F0=
Received: from mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-626-bM6Fq6_uPq22Ton1wLpvYQ-1; Fri,
 14 Nov 2025 09:43:26 -0500
X-MC-Unique: bM6Fq6_uPq22Ton1wLpvYQ-1
X-Mimecast-MFC-AGG-ID: bM6Fq6_uPq22Ton1wLpvYQ_1763131404
Received: from mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.93])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id A74A11800451;
	Fri, 14 Nov 2025 14:43:24 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.87])
	by mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 649D2180049F;
	Fri, 14 Nov 2025 14:43:22 +0000 (UTC)
...
Subject: [PATCH 6/9] cifs: Replace SendReceiveBlockingLock() with SendReceive() plus flags
Date: Fri, 14 Nov 2025 14:42:48 +0000
Message-ID: <20251114144253.1853312-7-dhowells@redhat.com>
...
index 22ff453ad172..7146225f4608 100644
--- a/fs/smb/client/cifsglob.h
+++ b/fs/smb/client/cifsglob.h
@@ -310,8 +310,9 @@ struct cifs_open_parms;
 struct cifs_credits;
...
@@ -1714,6 +1715,7 @@ struct smb_message {
...
@@ -1925,6 +1927,8 @@ enum cifs_writable_file_flags {
...
index 7af1e74b182b..8966bc512e96 100644
...
index e677f0c0647f..44c7d4d17b56 100644
