...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B314F587412
	for <lists+linux-cifs@lfdr.de>; Tue,  2 Aug 2022 00:48:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235382AbiHAWr6 (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Mon, 1 Aug 2022 18:47:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52772 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235031AbiHAWr5 (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Mon, 1 Aug 2022 18:47:57 -0400
Received: from mail-pj1-f42.google.com (mail-pj1-f42.google.com [209.85.216.42])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9E8ED25C60;
        Mon,  1 Aug 2022 15:47:55 -0700 (PDT)
Received: by mail-pj1-f42.google.com with SMTP id f11-20020a17090a4a8b00b001f2f7e32d03so350298pjh.0;
        Mon, 01 Aug 2022 15:47:55 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:x-gm-message-state:from:to:cc;
        bh=tX3HoQpC/gw8BsMGLkY9kxjrzkQd3Vsoh9tZ5jvPi/M=;
        b=
X-Gm-Message-State: ACgBeo052Ry40EbRQ4siWotvpRF91l/e4lN3exymsXGhpvZPjPbGIQRk
        ROzum/++rnaJg1dFoT6v0d5yQpAiWNw=
X-Google-Smtp-Source: AA6agR7XIIqLgLgZjMWTgBhFNNWV7xrqt18XNJFPvbHVqbI5is+A4Je9sQGGMyo5Oqm7ZBgX2UEO5g==
X-Received: by 2002:a17:902:7c83:b0:16d:3db9:fdc5 with SMTP id y3-20020a1709027c8300b0016d3db9fdc5mr18086507pll.153.1659394074549;
        Mon, 01 Aug 2022 15:47:54 -0700 (PDT)
Received: from localhost.localdomain ([211.49.23.9])
        by smtp.gmail.com with ESMTPSA id y7-20020aa79ae7000000b00525442ac579sm3416189pfp.212.2022.08.01.15.47.51
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 01 Aug 2022 15:47:54 -0700 (PDT)
From:   Namjae Jeon <linkinjeon@kernel.org>
To:     linux-cifs@vger.kernel.org
Cc:     dan.carpenter@oracle.com, smfrench@gmail.com, hyc.lee@gmail.com,
        senozhatsky@chromium.org, Namjae Jeon <linkinjeon@kernel.org>,
        stable@vger.kernel.org, zdi-disclosures@trendmicro.com
Subject: [PATCH v4] ksmbd: fix heap-based overflow in set_ntacl_dacl()
Date:   Tue,  2 Aug 2022 07:47:21 +0900
Message-Id: <20220801224721.12636-1-linkinjeon@kernel.org>
...
---
 ...
 v3:
   - change goto statement with break for smb_ace buffer validation
     check.
 v4:
   - fix variable dereferenced before check 'pntsd' reported by Dan Carpenter.
   - fix uninitialized symbol 'secdesclen' reported by Dan Carpenter.
...
index ea47aa0262ee..4c3c840df455 100644
...
index 38f23bf981ac..01e178513111 100644
--- a/fs/ksmbd/smbacl.c
+++ b/fs/ksmbd/smbacl.c
