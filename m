...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2D23E4175C7
	for <lists+linux-cifs@lfdr.de>; Fri, 24 Sep 2021 15:31:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346465AbhIXNdF (ORCPT <rfc822;lists+linux-cifs@lfdr.de>);
        Fri, 24 Sep 2021 09:33:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51986 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346284AbhIXNc7 (ORCPT
        <rfc822;linux-cifs@vger.kernel.org>); Fri, 24 Sep 2021 09:32:59 -0400
Received: from mail-pj1-x102d.google.com (mail-pj1-x102d.google.com [IPv6:2607:f8b0:4864:20::102d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 29BE3C03B19F
        for <linux-cifs@vger.kernel.org>; Fri, 24 Sep 2021 06:22:46 -0700 (PDT)
Received: by mail-pj1-x102d.google.com with SMTP id lp9-20020a17090b4a8900b0019ea2b54b61so189028pjb.1
        for <linux-cifs@vger.kernel.org>; Fri, 24 Sep 2021 06:22:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=L5D4uLvLZpkaW8KA+t6xbYDnbiMBAN6gnLPwWlFN63g=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=L5D4uLvLZpkaW8KA+t6xbYDnbiMBAN6gnLPwWlFN63g=;
        b=
X-Gm-Message-State: AOAM5323iYXL0E3Pby3H1+jLPdPOna3GMx2DCQByzEAnRgtU9Ri/FXez
        rYPK0l8yc/ic/CLN8LgXqGsWV4US0SbMQmNG
X-Google-Smtp-Source: ABdhPJzzzONVt+wz9GhcmODD9lWlr32pEQTeWO6dm9F3EYuiBbJ/EGcrjx0PUAGLJOuR1XN8BK1X3w==
X-Received: by 2002:a17:902:8b8b:b0:13d:e91c:a1b9 with SMTP id ay11-20020a1709028b8b00b0013de91ca1b9mr2519636plb.60.1632489765182;
        Fri, 24 Sep 2021 06:22:45 -0700 (PDT)
Received: from localhost.localdomain ([125.177.232.58])
        by smtp.googlemail.com with ESMTPSA id m126sm9682495pga.53.2021.09.24.06.22.42
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 24 Sep 2021 06:22:44 -0700 (PDT)
...
Subject: [PATCH v3] ksmbd: use LOOKUP_BENEATH to prevent the out of share access
Date:   Fri, 24 Sep 2021 22:22:21 +0900
Message-Id: <20210924132222.914168-1-hyc.lee@gmail.com>
...
Changes from v2:
 ...
 fs/ksmbd/vfs.c     | 162 ++++++++++++++++++++++++---------------------
 fs/ksmbd/vfs.h     |   9 ++-
 5 files changed, 143 insertions(+), 209 deletions(-)
...
index 9f45779c5f95..bb39b18a6673 100644
...
index 3733e4944c1d..809b6daf1fff 100644
--- a/fs/ksmbd/vfs.c
+++ b/fs/ksmbd/vfs.c
@@ -19,6 +19,8 @@
...
@@ -1206,27 +1195,30 @@ static int ksmbd_vfs_lookup_in_dir(struct path *dir, char *name, size_t namelen)
...
@@ -1276,12 +1267,29 @@ int ksmbd_vfs_kern_path(char *name, unsigned int flags, struct path *path,
