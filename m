Return-Path: <linux-cifs+bounces-8296-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C7B1CB6440
	for <lists+linux-cifs@lfdr.de>; Thu, 11 Dec 2025 16:04:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 123BE3017EEC
	for <lists+linux-cifs@lfdr.de>; Thu, 11 Dec 2025 15:03:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E55B529A1;
	Thu, 11 Dec 2025 15:03:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="YmJy7+5e"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5C1A323D2B4
	for <linux-cifs@vger.kernel.org>; Thu, 11 Dec 2025 15:03:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765465421; cv=none; b=gaVbHSTflSyYhipvSWr+nkMo/9BI4VmyzlviYXNwOFTmgrnn5/5VpO0aikmuLLg/Q7aP9O27IznJDXsNRKgc0eInifhTlpUdDKj+tov535IfPrFeGZznxwsWo+Rp3hDgJC+/8Lbiop3K0vUegyC/qIOP/hLyImHEzFHMWS/hr2I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765465421; c=relaxed/simple;
	bh=ugZbd2jNhbExo7DnBSQac1WZziv7uvYhhQHEn4TL17o=;
	h=From:In-Reply-To:References:To:Cc:Subject:MIME-Version:
	 Content-Type:Date:Message-ID; b=lBHsoWAqiAWbDWyYIvY4v10U+tQ19wnLEH8iiAOh0zKUL7t1VO5LGm/tnr8as6CXLpL2zAgMYWvWmMnZ5Bq5qTA+49lQs+NoGTYmFAIzQR2qNEm2bzW5G7Iizvpa7FxDqGZlnBdk2J15Pf/pCPeLhKr93u1wMgunRb4kGud/FaU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=YmJy7+5e; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1765465412;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=INTNnrTdeGy/Q9ughAJavUikN9lrbzqTpcic+ojrSvI=;
	b=YmJy7+5eE/zrGF8WK2vRx/lefeK9Wk7vWa3xPEPTMSCS+SvdbD4bYUnGvin5IJoJS1lyY6
	JHW+6DCmbtjyPv9jDLQ8+HHoHfosKfHhEJgbTkPA7MvzdPMWIdvDaPngPxTE8S4x91o3mz
	kVi4613GBHH/zm3HiANZFeJI68HMhNw=
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-463-qlAeIJEhMt6Ew80EI-n-_w-1; Thu,
 11 Dec 2025 10:03:26 -0500
X-MC-Unique: qlAeIJEhMt6Ew80EI-n-_w-1
X-Mimecast-MFC-AGG-ID: qlAeIJEhMt6Ew80EI-n-_w_1765465404
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 5B099195FCDD;
	Thu, 11 Dec 2025 15:03:23 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.42.28.14])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 1CA0C3000218;
	Thu, 11 Dec 2025 15:03:18 +0000 (UTC)
...
Subject: [PATCH 1/2] cifs: Label SMB2 statuses with errors
Precedence: bulk
...
Content-ID: <782535.1765465397.1@warthog.procyon.org.uk>
Content-Transfer-Encoding: quoted-printable
Date: Thu, 11 Dec 2025 15:03:17 +0000
Message-ID: <782536.1765465397@warthog.procyon.org.uk>
...
-#define STATUS_SYSTEM_POWERSTATE_COMPLEX_TRANSITION cpu_to_le32(0x4000003=
1)
...
-#define STATUS_GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET cpu_to_le32(0x401E034=
C)
-#define STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED c=
pu_to_le32(0x401E0351)
...
-#define STATUS_VIDEO_HUNG_DISPLAY_DRIVER_THREAD_RECOVERED cpu_to_le32(0x8=
01B00EB)
...
-#define STATUS_DS_NO_NEST_GLOBALGROUP_IN_MIXEDDOMAIN cpu_to_le32(0xC00002=
D5)
-#define STATUS_DS_NO_NEST_LOCALGROUP_IN_MIXEDDOMAIN cpu_to_le32(0xC00002D=
6)
-#define STATUS_DS_GLOBAL_CANT_HAVE_LOCAL_MEMBER cpu_to_le32(0xC00002D7)
-#define STATUS_DS_GLOBAL_CANT_HAVE_UNIVERSAL_MEMBER cpu_to_le32(0xC00002D=
8)
-#define STATUS_DS_UNIVERSAL_CANT_HAVE_LOCAL_MEMBER cpu_to_le32(0xC00002D9=
)
-#define STATUS_DS_GLOBAL_CANT_HAVE_CROSSDOMAIN_MEMBER cpu_to_le32(0xC0000=
2DA)
-#define STATUS_DS_LOCAL_CANT_HAVE_CROSSDOMAIN_LOCAL_MEMBER cpu_to_le32(0x=
C00002DB)
...
+#define STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED s=
t(0x401E0351, -EIO)
...
+#define STATUS_VIDEO_HUNG_DISPLAY_DRIVER_THREAD_RECOVERED st(0x801B00EB, =
-EIO)
...
+#define STATUS_DS_LOCAL_CANT_HAVE_CROSSDOMAIN_LOCAL_MEMBER st(0xC00002DB,=
 -EIO)
...
-#define STATUS_ACCESS_DISABLED_NO_SAFER_UI_BY_POLICY cpu_to_le32(0xC00003=
72)
...
-#define STATUS_INSUFFICIENT_RESOURCE_FOR_SPECIFIED_SHARED_SECTION_SIZE cp=
u_to_le32(0xC0000416)
...
-#define STATUS_CS_ENCRYPTION_INVALID_SERVER_RESPONSE cpu_to_le32(0xC00004=
41)
-#define STATUS_CS_ENCRYPTION_UNSUPPORTED_SERVER cpu_to_le32(0xC0000442)
-#define STATUS_CS_ENCRYPTION_EXISTING_ENCRYPTED_FILE cpu_to_le32(0xC00004=
43)
...
-#define STATUS_THREADPOOL_SET_EVENT_ON_COMPLETION_FAILED cpu_to_le32(0xC0=
00070B)
-#define STATUS_THREADPOOL_RELEASE_SEMAPHORE_ON_COMPLETION_FAILED cpu_to_l=
e32(0xC000070C)
-#define STATUS_THREADPOOL_RELEASE_MUTEX_ON_COMPLETION_FAILED cpu_to_le32(=
0xC000070D)
-#define STATUS_THREADPOOL_FREE_LIBRARY_ON_COMPLETION_FAILED cpu_to_le32(0=
xC000070E)
-#define STATUS_THREADPOOL_RELEASED_DURING_OPERATION cpu_to_le32(0xC000070=
F)
-#define STATUS_CALLBACK_RETURNED_WHILE_IMPERSONATING cpu_to_le32(0xC00007=
10)
...
-#define STATUS_LOST_WRITEBEHIND_DATA_NETWORK_DISCONNECTED cpu_to_le32(0xC=
000A080)
-#define STATUS_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR cpu_to_le32(0xC=
000A081)
-#define STATUS_LOST_WRITEBEHIND_DATA_LOCAL_DISK_ERROR cpu_to_le32(0xC000A=
082)
...
-#define STATUS_SXS_SYSTEM_DEFAULT_ACTIVATION_CONTEXT_EMPTY cpu_to_le32(0x=
C0150012)
...
-#define STATUS_SXS_INVALID_IDENTITY_ATTRIBUTE_VALUE cpu_to_le32(0xC015001=
6)
...
-#define STATUS_SXS_MANIFEST_IDENTITY_SAME_BUT_CONTENTS_DIFFERENT cpu_to_l=
e32(0xC015001C)
...
-#define STATUS_MINIVERSION_INACCESSIBLE_FROM_SPECIFIED_TRANSACTION cpu_to=
_le32(0xC0190024)
-#define STATUS_CANT_OPEN_MINIVERSION_WITH_MODIFY_INTENT cpu_to_le32(0xC01=
90025)
-#define STATUS_CANT_CREATE_MORE_STREAM_MINIVERSIONS cpu_to_le32(0xC019002=
6)
...
-#define STATUS_TRANSACTED_MAPPING_UNSUPPORTED_REMOTE cpu_to_le32(0xC01900=
40)
...
-#define STATUS_TRANSACTIONMANAGER_RECOVERY_NAME_COLLISION cpu_to_le32(0xC=
0190053)
-#define STATUS_TRANSACTION_NOT_ROOT cpu_to_le32(0xC0190054)
-#define STATUS_TRANSACTION_OBJECT_EXPIRED cpu_to_le32(0xC0190055)
-#define STATUS_COMPRESSION_NOT_ALLOWED_IN_TRANSACTION cpu_to_le32(0xC0190=
056)
...
-#define STATUS_OPERATION_NOT_SUPPORTED_IN_TRANSACTION cpu_to_le32(0xC0190=
05A)
...
-#define STATUS_MONITOR_INVALID_STANDARD_TIMING_BLOCK cpu_to_le32(0xC01D00=
04)
-#define STATUS_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED cpu_to_le32(0xC0=
1D0005)
-#define STATUS_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK cpu_to_le32(0xC=
01D0006)
-#define STATUS_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK cpu_to_le32(0xC=
01D0007)
-#define STATUS_MONITOR_NO_MORE_DESCRIPTOR_DATA cpu_to_le32(0xC01D0008)
-#define STATUS_MONITOR_INVALID_DETAILED_TIMING_BLOCK cpu_to_le32(0xC01D00=
09)
...
-#define STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE cpu_to_le32(0xC0=
1E0107)
-#define STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED cpu_to_le32(0xC0=
1E0108)
-#define STATUS_GRAPHICS_CANT_EVICT_PINNED_ALLOCATION cpu_to_le32(0xC01E01=
09)
-#define STATUS_GRAPHICS_INVALID_ALLOCATION_USAGE cpu_to_le32(0xC01E0110)
-#define STATUS_GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION cpu_to_le32(0xC01E0=
111)
-#define STATUS_GRAPHICS_ALLOCATION_CLOSED cpu_to_le32(0xC01E0112)
-#define STATUS_GRAPHICS_INVALID_ALLOCATION_INSTANCE cpu_to_le32(0xC01E011=
3)
...
-#define STATUS_GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED cpu_to_le32(0xC01E03=
01)
-#define STATUS_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED cpu_to_le3=
2(0xC01E0302)
-#define STATUS_GRAPHICS_INVALID_VIDPN cpu_to_le32(0xC01E0303)
-#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE cpu_to_le32(0xC01E03=
04)
-#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET cpu_to_le32(0xC01E03=
05)
-#define STATUS_GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED cpu_to_le32(0xC01E03=
06)
-#define STATUS_GRAPHICS_INVALID_VIDPN_SOURCEMODESET cpu_to_le32(0xC01E030=
8)
-#define STATUS_GRAPHICS_INVALID_VIDPN_TARGETMODESET cpu_to_le32(0xC01E030=
9)
...
-#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE cpu_to_le32(0xC=
01E0310)
-#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE cpu_to_le32(0xC=
01E0311)
-#define STATUS_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET cpu_to_le32(0xC01E=
0312)
...
-#define STATUS_GRAPHICS_INVALID_VIDEOPRESENTSOURCESET cpu_to_le32(0xC01E0=
315)
-#define STATUS_GRAPHICS_INVALID_VIDEOPRESENTTARGETSET cpu_to_le32(0xC01E0=
316)
...
-#define STATUS_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY cpu_to_le32(0xC01E0=
31A)
-#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET cpu_to_le32(0xC=
01E031B)
-#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE cpu_to_le32(0xC01E=
031C)
-#define STATUS_GRAPHICS_FREQUENCYRANGE_NOT_IN_SET cpu_to_le32(0xC01E031D)
-#define STATUS_GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET cpu_to_le32(0xC01E0=
31F)
-#define STATUS_GRAPHICS_STALE_MODESET cpu_to_le32(0xC01E0320)
-#define STATUS_GRAPHICS_INVALID_MONITOR_SOURCEMODESET cpu_to_le32(0xC01E0=
321)
-#define STATUS_GRAPHICS_INVALID_MONITOR_SOURCE_MODE cpu_to_le32(0xC01E032=
2)
-#define STATUS_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN cpu_to_le32(0xC01=
E0323)
-#define STATUS_GRAPHICS_MODE_ID_MUST_BE_UNIQUE cpu_to_le32(0xC01E0324)
-#define STATUS_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION c=
pu_to_le32(0xC01E0325)
-#define STATUS_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES cpu_to_le=
32(0xC01E0326)
...
(0xC01E0329)
-#define STATUS_GRAPHICS_INVALID_MONITORDESCRIPTORSET cpu_to_le32(0xC01E03=
2A)
-#define STATUS_GRAPHICS_INVALID_MONITORDESCRIPTOR cpu_to_le32(0xC01E032B)
-#define STATUS_GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET cpu_to_le32(0xC01E03=
2C)
-#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET cpu_to_le32(0xC0=
1E032D)
-#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE cpu_to_le32(0=
xC01E032E)
-#define STATUS_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE cpu_to_le32(0xC0=
1E032F)
...
-#define STATUS_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER cpu_=
to_le32(0xC01E0334)
...
-#define STATUS_GRAPHICS_INVALID_PRIMARYSURFACE_SIZE cpu_to_le32(0xC01E033=
A)
...
-#define STATUS_GRAPHICS_INVALID_PIXELVALUEACCESSMODE cpu_to_le32(0xC01E03=
3F)
-#define STATUS_GRAPHICS_TARGET_NOT_IN_TOPOLOGY cpu_to_le32(0xC01E0340)
-#define STATUS_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT cpu_to_le32(0x=
C01E0341)
...
-#define STATUS_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL cpu_to_le32(0xC01=
E0344)
-#define STATUS_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION cpu_=
to_le32(0xC01E0345)
-#define STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTE=
D cpu_to_le32(0xC01E0346)
...
-#define STATUS_GRAPHICS_MULTISAMPLING_NOT_SUPPORTED cpu_to_le32(0xC01E034=
9)
-#define STATUS_GRAPHICS_MODE_NOT_IN_MODESET cpu_to_le32(0xC01E034A)
-#define STATUS_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON cpu_=
to_le32(0xC01E034D)
-#define STATUS_GRAPHICS_INVALID_PATH_CONTENT_TYPE cpu_to_le32(0xC01E034E)
-#define STATUS_GRAPHICS_INVALID_COPYPROTECTION_TYPE cpu_to_le32(0xC01E034=
F)
-#define STATUS_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS cpu_to_le32(0xC=
01E0350)
-#define STATUS_GRAPHICS_INVALID_SCANLINE_ORDERING cpu_to_le32(0xC01E0352)
-#define STATUS_GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED cpu_to_le32(0xC01E03=
53)
-#define STATUS_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS cpu_to_le32(0xC0=
1E0354)
-#define STATUS_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT cpu_to_le32(0xC01E035=
5)
-#define STATUS_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM cpu_to_le32(0xC01E=
0356)
-#define STATUS_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN cpu_to_le32(0xC=
01E0357)
-#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT cpu_to_=
le32(0xC01E0358)
-#define STATUS_GRAPHICS_MAX_NUM_PATHS_REACHED cpu_to_le32(0xC01E0359)
-#define STATUS_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION cpu_to_le32(0x=
C01E035A)
...
-#define STATUS_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED cpu_to_le32(0xC=
01E0400)
-#define STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED cpu_to_le32(0xC01E=
0401)
...
-#define STATUS_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE cpu_to_le32(0xC01E=
0436)
-#define STATUS_GRAPHICS_NOT_POST_DEVICE_DRIVER cpu_to_le32(0xC01E0438)
-#define STATUS_GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED cpu_to_le32(0xC01E043=
B)
-#define STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS=
 cpu_to_le32(0xC01E051C)
-#define STATUS_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST cpu_to_le32(0xC01=
E051D)
...
-#define STATUS_GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED cpu_to_le32(0xC01E052=
0)
-#define STATUS_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST cpu_to_le32(0xC=
01E0521)
...
-#define STATUS_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS cpu_to_le32(0xC0=
1E0503)
-#define STATUS_GRAPHICS_OPM_PARAMETER_ARRAY_TOO_SMALL cpu_to_le32(0xC01E0=
504)
-#define STATUS_GRAPHICS_OPM_NO_PROTECTED_OUTPUTS_EXIST cpu_to_le32(0xC01E=
0505)
-#define STATUS_GRAPHICS_PVP_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME cpu_to_=
le32(0xC01E0506)
-#define STATUS_GRAPHICS_PVP_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP cpu_to=
_le32(0xC01E0507)
-#define STATUS_GRAPHICS_PVP_MIRRORING_DEVICES_NOT_SUPPORTED cpu_to_le32(0=
xC01E0508)
...
-#define STATUS_GRAPHICS_PVP_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE cpu_=
to_le32(0xC01E050D)
-#define STATUS_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH cpu_to_le32(0xC01E=
050E)
...
-#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP cpu_to_le32(0xC0=
1E0513)
-#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP cpu_to_le32(0xC01=
E0514)
-#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA cpu_to_le32(0xC=
01E0515)
...
(0xC01E051A)
-#define STATUS_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS cpu_to_le32(0=
xC01E051B)
...
-#define STATUS_GRAPHICS_I2C_ERROR_TRANSMITTING_DATA cpu_to_le32(0xC01E058=
2)
...
-#define STATUS_GRAPHICS_DDCCI_INVALID_CAPABILITIES_STRING cpu_to_le32(0xC=
01E0587)
-#define STATUS_GRAPHICS_MCA_INTERNAL_ERROR cpu_to_le32(0xC01E0588)
-#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND cpu_to_le32(0xC01E0=
589)
-#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH cpu_to_le32(0xC01E05=
8A)
-#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM cpu_to_le32(0xC01E=
058B)
-#define STATUS_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE cpu_to_le32(0xC01=
E058C)
-#define STATUS_GRAPHICS_MONITOR_NO_LONGER_EXISTS cpu_to_le32(0xC01E058D)
-#define STATUS_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED cpu_to_le32(0xC01E=
05E0)
-#define STATUS_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME cpu_to_le32=
(0xC01E05E1)
-#define STATUS_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP cpu_to_le3=
2(0xC01E05E2)
-#define STATUS_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED cpu_to_le32(0xC01=
E05E3)
-#define STATUS_GRAPHICS_INVALID_POINTER cpu_to_le32(0xC01E05E4)
-#define STATUS_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE cpu_to_l=
e32(0xC01E05E5)
...
-#define STATUS_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS cpu_to_le32(0xC01=
E05E8)
...
-#define STATUS_FWP_ACTION_INCOMPATIBLE_WITH_SUBLAYER cpu_to_le32(0xC02200=
2D)
-#define STATUS_FWP_CONTEXT_INCOMPATIBLE_WITH_LAYER cpu_to_le32(0xC022002E=
)
-#define STATUS_FWP_CONTEXT_INCOMPATIBLE_WITH_CALLOUT cpu_to_le32(0xC02200=
2F)
...
+#define STATUS_ACCESS_DISABLED_NO_SAFER_UI_BY_POLICY st(0xC0000372, -EACC=
ES)
...
+#define STATUS_INSUFFICIENT_RESOURCE_FOR_SPECIFIED_SHARED_SECTION_SIZE st=
(0xC0000416, -EIO)
...
+#define STATUS_THREADPOOL_SET_EVENT_ON_COMPLETION_FAILED st(0xC000070B, -=
EIO)
+#define STATUS_THREADPOOL_RELEASE_SEMAPHORE_ON_COMPLETION_FAILED st(0xC00=
0070C, -EIO)
+#define STATUS_THREADPOOL_RELEASE_MUTEX_ON_COMPLETION_FAILED st(0xC000070=
D, -EIO)
+#define STATUS_THREADPOOL_FREE_LIBRARY_ON_COMPLETION_FAILED st(0xC000070E=
, -EIO)
...
+#define STATUS_LOST_WRITEBEHIND_DATA_NETWORK_DISCONNECTED st(0xC000A080, =
-EIO)
+#define STATUS_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR st(0xC000A081, =
-EIO)
...
+#define STATUS_SXS_SYSTEM_DEFAULT_ACTIVATION_CONTEXT_EMPTY st(0xC0150012,=
 -EIO)
...
+#define STATUS_SXS_MANIFEST_IDENTITY_SAME_BUT_CONTENTS_DIFFERENT st(0xC01=
5001C, -EIO)
...
+#define STATUS_MINIVERSION_INACCESSIBLE_FROM_SPECIFIED_TRANSACTION st(0xC=
0190024, -EIO)
+#define STATUS_CANT_OPEN_MINIVERSION_WITH_MODIFY_INTENT st(0xC0190025, -E=
IO)
...
+#define STATUS_TRANSACTIONMANAGER_RECOVERY_NAME_COLLISION st(0xC0190053, =
-EIO)
...
+#define STATUS_OPERATION_NOT_SUPPORTED_IN_TRANSACTION st(0xC019005A, -EOP=
NOTSUPP)
...
+#define STATUS_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED st(0xC01D0005, -=
EIO)
+#define STATUS_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK st(0xC01D0006, =
-EIO)
+#define STATUS_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK st(0xC01D0007, =
-EIO)
...
+#define STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE st(0xC01E0107, -=
EIO)
+#define STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED st(0xC01E0108, -=
EIO)
...
+#define STATUS_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED st(0xC01E0=
302, -EIO)
...
+#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE st(0xC01E0310, =
-EIO)
+#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE st(0xC01E0311, =
-EIO)
+#define STATUS_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET st(0xC01E0312, -EI=
O)
...
+#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET st(0xC01E031B, =
-EIO)
+#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE st(0xC01E031C, -EI=
O)
...
+#define STATUS_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN st(0xC01E0323, -E=
IO)
+#define STATUS_GRAPHICS_MODE_ID_MUST_BE_UNIQUE	st(0xC01E0324, -EIO)
+#define STATUS_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION s=
t(0xC01E0325, -EIO)
+#define STATUS_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES st(0xC01E=
0326, -EIO)
+#define STATUS_GRAPHICS_PATH_NOT_IN_TOPOLOGY	st(0xC01E0327, -EIO)
+#define STATUS_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE st(0xC01E03=
28, -EIO)
+#define STATUS_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET st(0xC01E03=
29, -EIO)
...
+#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET st(0xC01E032D, -=
EIO)
+#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE st(0xC01E032E=
, -EIO)
+#define STATUS_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE st(0xC01E032F, -=
EIO)
...
+#define STATUS_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER st(0=
xC01E0334, -EIO)
...
+#define STATUS_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT st(0xC01E0341,=
 -EIO)
...
+#define STATUS_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL st(0xC01E0344, -E=
IO)
+#define STATUS_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION st(0=
xC01E0345, -EIO)
+#define STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTE=
D st(0xC01E0346, --EIO)
...
+#define STATUS_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON st(0=
xC01E034D, -EIO)
...
+#define STATUS_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS st(0xC01E0350, =
-EIO)
...
+#define STATUS_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS st(0xC01E0354, -=
EIO)
+#define STATUS_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT st(0xC01E0355, -EIO)
+#define STATUS_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM st(0xC01E0356, -EI=
O)
+#define STATUS_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN st(0xC01E0357, =
-EIO)
+#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT st(0xC0=
1E0358, -EIO)
+#define STATUS_GRAPHICS_MAX_NUM_PATHS_REACHED	st(0xC01E0359, -EIO)
+#define STATUS_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION st(0xC01E035A,=
 -EIO)
+#define STATUS_GRAPHICS_INVALID_CLIENT_TYPE	st(0xC01E035B, -EIO)
+#define STATUS_GRAPHICS_CLIENTVIDPN_NOT_SET	st(0xC01E035C, -EIO)
+#define STATUS_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED st(0xC01E0400, =
-EIO)
+#define STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED st(0xC01E0401, -EI=
O)
...
+#define STATUS_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE st(0xC01E0436, -EI=
O)
...
+#define STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS=
 st(0xC01E051C, --EIO)
+#define STATUS_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST st(0xC01E051D, -E=
IO)
...
+#define STATUS_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST st(0xC01E0521, =
-EIO)
...
+#define STATUS_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS st(0xC01E0503, -=
EIO)
+#define STATUS_GRAPHICS_OPM_PARAMETER_ARRAY_TOO_SMALL st(0xC01E0504, -EIO=
)
+#define STATUS_GRAPHICS_OPM_NO_PROTECTED_OUTPUTS_EXIST st(0xC01E0505, -EI=
O)
+#define STATUS_GRAPHICS_PVP_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME st(0xC0=
1E0506, -EIO)
+#define STATUS_GRAPHICS_PVP_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP st(0xC=
01E0507, -EIO)
+#define STATUS_GRAPHICS_PVP_MIRRORING_DEVICES_NOT_SUPPORTED st(0xC01E0508=
, -EIO)
...
+#define STATUS_GRAPHICS_PVP_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE st(0=
xC01E050D, -EIO)
+#define STATUS_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH st(0xC01E050E, -EI=
O)
...
+#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP st(0xC01E0513, -=
EIO)
+#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP st(0xC01E0514, -E=
IO)
+#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA st(0xC01E0515, =
-EIO)
...
+#define STATUS_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE st(0xC01E051=
8, -EIO)
+#define STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_NO_LONGER_EXISTS st(0xC01E05=
1A, -EIO)
+#define STATUS_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS st(0xC01E051B=
, -EIO)
...
+#define STATUS_GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE=
 st(0xC01E0586, --EIO)
+#define STATUS_GRAPHICS_DDCCI_INVALID_CAPABILITIES_STRING st(0xC01E0587, =
-EIO)
...
+#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM st(0xC01E058B, -EI=
O)
+#define STATUS_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE st(0xC01E058C, -E=
IO)
+#define STATUS_GRAPHICS_MONITOR_NO_LONGER_EXISTS st(0xC01E058D, -EIO)
+#define STATUS_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED st(0xC01E05E0, -EI=
O)
+#define STATUS_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME st(0xC01E05=
E1, -EIO)
+#define STATUS_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP st(0xC01E0=
5E2, -EIO)
+#define STATUS_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED st(0xC01E05E3, -E=
IO)
+#define STATUS_GRAPHICS_INVALID_POINTER		st(0xC01E05E4, -EIO)
+#define STATUS_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE st(0xC01=
E05E5, -EIO)
...
+#define STATUS_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS st(0xC01E05E8, -E=
IO)
...
+#define STATUS_IPSEC_CLEAR_TEXT_DROP		st(0xC0360007, -EIO)
 /* See MS-SMB2 3.3.5.4 */
-#define STATUS_SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP cpu_to_le32(0xC05D00=
00)
