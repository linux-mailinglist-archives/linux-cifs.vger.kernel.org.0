Return-Path: <linux-cifs+bounces-8297-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 91AEFCB6447
	for <lists+linux-cifs@lfdr.de>; Thu, 11 Dec 2025 16:04:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 2F1873017EF1
	for <lists+linux-cifs@lfdr.de>; Thu, 11 Dec 2025 15:04:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 905EA23D2B4;
	Thu, 11 Dec 2025 15:04:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Wyz09T+E"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ED6EF29A1
	for <linux-cifs@vger.kernel.org>; Thu, 11 Dec 2025 15:04:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765465468; cv=none; b=uohtFhumVs2iTPaLqfV4qF8dfIgKJFTgJlMChA7yrm5KS6hcUKQ5zRW4Au2Y6ey3cX1xR8aYeTQA2sg6Uckt3WzvHEmsUcG205pEp5CM5J138dtZIML8heJrZ4c3sx3eCH/sJlbTBked0jd1Aql4g+SydHIezqOtEUCdn9erSls=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765465468; c=relaxed/simple;
	bh=iLZ9mEpzKxv+1rLgU1VySj702we46uts8XKQ2swWR3A=;
	h=From:In-Reply-To:References:To:Cc:Subject:MIME-Version:
	 Content-Type:Date:Message-ID; b=BE9uHqw+4SpP3Tq68Gb8K0qIxKI6hkDtc8lcMzCX/EddeBq/tNWVu8bz8iLCyOHCDhz/R+JlCKiiXc5W74F/AHXZaGRQ1Qw6K5rlevgL1+KKKFk5VHYxK87Qu7zxCj/u3ddKrcX1c+I6zQqxv1jcQYYje/xnEr/GFMCIkY24qyo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Wyz09T+E; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1765465461;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=PLqRU+fuFPdxak3KsiV1qDkR2vFgf7MrVyzNbXzk9Ss=;
	b=Wyz09T+ElG/poLmzk2MgkrwmiC0Kn9DfqmvfR8aeTpfeI0VnJMfC/fk8d+ZeuWtL1uvTAs
	Okx3oGDGSjrgi1j7lRgFTbnlQVxLOsGpSf/VNoTOD3FZ+Jg1TLdwZcqZEoc4DQXpnlJdyx
	V1j7vBu7wS6xkcQhRzb8ZSC7ymcgqeo=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-310-zXgpC0P0OaG3iZ-Hrk131g-1; Thu,
 11 Dec 2025 10:04:17 -0500
X-MC-Unique: zXgpC0P0OaG3iZ-Hrk131g-1
X-Mimecast-MFC-AGG-ID: zXgpC0P0OaG3iZ-Hrk131g_1765465455
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 17EFF1800451;
	Thu, 11 Dec 2025 15:04:15 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.42.28.14])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id D786130001A2;
	Thu, 11 Dec 2025 15:04:11 +0000 (UTC)
...
Subject: [PATCH 2/2] cifs: Autogenerate SMB2 error mapping table
Precedence: bulk
...
Content-ID: <782577.1765465450.1@warthog.procyon.org.uk>
Content-Transfer-Encoding: quoted-printable
Date: Thu, 11 Dec 2025 15:04:10 +0000
Message-ID: <782578.1765465450@warthog.procyon.org.uk>
...
@@ -35,3 +35,17 @@ cifs-$(CONFIG_CIFS_ROOT) +=3D cifsroot.o
 cifs-$(CONFIG_CIFS_ALLOW_INSECURE_LEGACY) +=3D smb1ops.o cifssmb.o cifstr=
ansport.o
 =
...
+
+quiet_cmd_gen_smb2_mapping =3D GEN     $@
+      cmd_gen_smb2_mapping =3D perl $(src)/gen_smb2_mapping $< $@
+
+clean-files	+=3D smb2_mapping_table.c
diff --git a/fs/smb/client/gen_smb2_mapping b/fs/smb/client/gen_smb2_mappi=
ng
...
+#
+# Generate an SMB2 status -> error mapping table, sorted by NT status cod=
e.
+#
...
+
+
+@list =3D sort( { $a->{ncode} <=3D> $b->{ncode} } @list);
+
+open OUT_FILE, ">$ARGV[1]" || die;
+foreach my $entry (@list) {
+    my $status =3D $entry->{status};
+    my $code   =3D $entry->{code};
+    my $ncode  =3D $entry->{ncode};
+    my $error  =3D $entry->{error};
+
...
@@ -23,2401 +23,7 @@ struct status_to_posix_error {
 ...
 static const struct status_to_posix_error smb2_error_map_table[] =3D {
...
-	{STATUS_INVALID_DEVICE_REQUEST, -EOPNOTSUPP, "STATUS_INVALID_DEVICE_REQU=
EST"},
