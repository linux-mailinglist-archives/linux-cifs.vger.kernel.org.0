Return-Path: <linux-cifs+bounces-7761-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 0777BC7EA3A
	for <lists+linux-cifs@lfdr.de>; Mon, 24 Nov 2025 00:55:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 0866A4E499B
	for <lists+linux-cifs@lfdr.de>; Sun, 23 Nov 2025 23:54:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B30D927F005;
	Sun, 23 Nov 2025 23:53:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="irrESu7G"
X-Original-To: linux-cifs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DA34D278E63
	for <linux-cifs@vger.kernel.org>; Sun, 23 Nov 2025 23:53:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763942008; cv=none; b=fOtaz7jYB7NjvYSFy3gWHalMS5dfQwyAIWEA2LLAW4HdeCPLCBZKrvu+hH3Cv8BRDM44NqgLNKvj31sNtiCDDnrgseo01vFf5DAEgXdJ3UOr0ucCy8FiOlBI/0ZdkaLrWOHqAeSjUUN2AF05WTXhFC7OSi1+glArWMR3gydStIY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763942008; c=relaxed/simple;
	bh=aqBSMZFvMQgopqI7mY37gBih3Ef6j66oFS00W/5SexY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=t8N3zxCpcN3G3WS1A2ZiU6iuc2vY9Aa1GriznLmmxy3rd7NStGRDmQJoeO+jfmYE8gIFoWUs8C2d+tZSAlLBNwOp3hVX9CNTfilK5PgtOB2BxUConApUkDYolEkwH8BwBtd5dEEJRxrzuv3fVLBZ0hBNrHdapPbDx9JXE8jKpyM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=irrESu7G; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=TOJRjq1sAGk9vISsDSQPkoht7CM7xfmNBYgdxBLFSYU=;
	b=irrESu7G1LvdBB+GffSdYiI9Uodfc8EpcvFIV25AaCMD9/hjCWgrfdu97sQ/J3jcKbmohl
	gD2aoXatW7HBR5hm+K93o9u+vrMAQOMOL/efrS8OC2Im8V6Jc8EdbrRabtl0FVo2dyJfVy
	CebG/nXvtvougMQoqFSQugO3iJNuiCM=
Received: from mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-403-WmsjzcIzMpCiVcS2Xynstw-1; Sun,
 23 Nov 2025 18:53:14 -0500
X-MC-Unique: WmsjzcIzMpCiVcS2Xynstw-1
X-Mimecast-MFC-AGG-ID: WmsjzcIzMpCiVcS2Xynstw_1763941992
Received: from mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.111])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 3D4611956095;
	Sun, 23 Nov 2025 23:53:12 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.42.28.14])
	by mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 2FEBB180047F;
	Sun, 23 Nov 2025 23:53:09 +0000 (UTC)
...
Subject: [PATCH v3 06/12] cifs: Remove the RFC1002 header from smb_hdr
Date: Sun, 23 Nov 2025 23:52:33 +0000
Message-ID: <20251123235242.3361706-7-dhowells@redhat.com>
...
index 511953fa5ae4..4062be626d8e 100644
--- a/fs/smb/client/cifsproto.h
+++ b/fs/smb/client/cifsproto.h
@@ -69,7 +69,8 @@ int cifs_sign_rqst(struct smb_rqst *rqst, struct TCP_Server_Info *server,
 		   __u32 *pexpected_response_sequence_number);
...
+		  struct TCP_Server_Info *server,
 ...
 int cifs_verify_signature(struct smb_rqst *rqst,
 			  struct TCP_Server_Info *server,
@@ -400,10 +401,11 @@ void cifs_buf_release(void *buf_to_free);
...
index c116bfb20c4d..1580ed15aca2 100644
