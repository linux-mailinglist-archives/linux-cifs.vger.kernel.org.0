Return-Path: <linux-cifs+bounces-2355-lists+linux-cifs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-cifs@lfdr.de
Delivered-To: lists+linux-cifs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id C6FCC93DB9C
	for <lists+linux-cifs@lfdr.de>; Sat, 27 Jul 2024 02:02:39 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7B440287726
	for <lists+linux-cifs@lfdr.de>; Sat, 27 Jul 2024 00:02:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AB87C17E450;
	Fri, 26 Jul 2024 23:53:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="JYcYrN7S"
X-Original-To: linux-cifs@vger.kernel.org
Received: from mail-lf1-f47.google.com (mail-lf1-f47.google.com [209.85.167.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5E19717D8B3
	for <linux-cifs@vger.kernel.org>; Fri, 26 Jul 2024 23:53:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.47
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1722038016; cv=none; b=NeYG6VhmQB6a9LHCmixnffQ92cwDKN5PwP1JyjpwEEU3eZzigb6cSoNPofsXJISylkIXIdXsSiUIXkWvBF348pitSWhGUghvuOmWUdU7Zpg68/Y7ReJBbJmHWP36ano3xXKgn7mllFy8gQghdbl7tC5e6vgJ8GEwcHjX+HWOUhg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1722038016; c=relaxed/simple;
	bh=fXtpCa9jihWsqO8NdnOq4Q3SClK+H7AZ80FWLbKPHUE=;
	h=MIME-Version:From:Date:Message-ID:Subject:To:Cc:Content-Type; b=X6Bp+L+jpchJsEuMduBXvPexdEZy7+zGFlAeS0a3DLjh7HghlDqoTgc9mIZKOC1lFTfzO4ffoMmHToD6mR4k7S7wZLDrQgWaZRckeJnAkFPPNp5pbODlyOhqYFqrefjjnji/7z9zVaeCk40bNFXOjrjK5qZIXoZZ6B6nTclndwY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=JYcYrN7S; arc=none smtp.client-ip=209.85.167.47
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-lf1-f47.google.com with SMTP id 2adb3069b0e04-52f04150796so2782338e87.3
        for <linux-cifs@vger.kernel.org>; Fri, 26 Jul 2024 16:53:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1722038011; x=1722642811; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:mime-version:from:to:cc:subject
         :date:message-id:reply-to;
        bh=nnlIb8do12YhsqDoREzy6tkDteJQhUbA2FOMCTWaIjs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=nnlIb8do12YhsqDoREzy6tkDteJQhUbA2FOMCTWaIjs=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVJFijehBL6ookE2RtRK/CNqUZHhgL49zGjnqx71H98i69hR5sbFCBxuhMNUeOjNV8GycU5YajcvrnCMt0zwNaWrUSRH4GosNGsSQ==
X-Gm-Message-State: AOJu0Yz/NGgEMx77o14ANhDxEbc/H0lw1yGHtbteTpJg5gk0asc9Qb0m
	G5l9mac6V8QP1YqSeXED5dvTbZSTZkjmFtQE+QihZ5LipVytA1sfispapC4V1ViezarCgUa/bHS
	OMEw8Pm9KQPIKjR5YI7UOE67ojfQ=
...
Content-Type: multipart/alternative; boundary="000000000000eced38061e2f3761"

--000000000000eced38061e2f3761
...
<div dir=3D"ltr">Since some of Enzo&#39;s compression patch series has to b=
e changed due to David Howell&#39;s netfs changes to cifs.ko over the past =
two releases, I split out the obvious parts of his patch to implement the c=
lient side of SMB3.1.1 compression on write requests (see=C2=A0<a href=3D"h=
ttps://git.exis.tech/linux.git/patch/?id=3D40414c6a34081b372e45c7ce5060a6d3=
4779f6ba">https://git.exis.tech/linux.git/patch/?id=3D40414c6a34081b372e45c=
7ce5060a6d34779f6ba</a> for the original patch of Enzo&#39;s) but left out =
the final piece of the patch (the calls from the write path).<div><br></div=
><div>This moves SMB3.1.1 compression code into experimental config option,=
<br>and fixes the compress mount option to require that config option.=C2=
=A0</div><div>Also implements unchained LZ77 &quot;plain&quot; compression =
algorithm as per</div><div>MS-XCA specification section &quot;2.3 Plain LZ7=
7 Compression Algorithm Details&quot;.</div><div><br></div><div>See attache=
d</div><div><div><br></div><span class=3D"gmail_signature_prefix">--</span>=
<br><div dir=3D"ltr" class=3D"gmail_signature" data-smartmail=3D"gmail_sign=
ature">Thanks,<br><br>Steve</div></div></div>
